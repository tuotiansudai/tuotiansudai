...
public class ActivityConsoleExerciseVSWorkService {
    ...
    public BasePaginationDataDto<UserExchangePrizeModel> exchangePrizeList(int index, int pageSize){
        ...
        List<UserExchangePrizeModel> userExchangePrizeModels = userExchangePrizeMapper.findUserExchangePrizeViews(null, null, null, ActivityCategory.EXERCISE_WORK_ACTIVITY, startTime, endTime, null, null);
