...
<@global.main pageCss="" pageJavascript="promotion.js" headLab="content-manage" sideLab="promotion" title="APP弹窗推送添加">
                ...
                <div class="col-sm-4">
                    <select class="selectpicker linkUrl" name="linkUrl">
                        <#list appUrls as appUrl>
                            <option value="${appUrl.path}" >${appUrl.description}</option>
                        </#list>
                    </select>
                    <div class="app-push-link jump-to-link">定位地址:<input type="text" class="form-control jump-link-text" name="jumpToLink" placeholder=""  maxlength="100" datatype="*" errormsg="定位地址不能为空"></div>
                </div>
                <div class="col-sm-7">
                </div>
            </div>
