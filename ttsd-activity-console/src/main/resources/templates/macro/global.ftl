    ...
    [
        ...
        },
        {
            ...
            "sidebar":[
                ...
                {"name":"","class":"sub-title-1","text":"用户资金发放","link":"","role":"'ADMIN','CUSTOMER_SERVICE','OPERATOR','OPERATOR_ADMIN'"},
                    {"name":"creditLoanBill","text":"发放记录","link":"/finance-manage/payroll","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN'"}
            ]
        },
        {
            "name":"content-manage",
