    ...
    [
        ...
        },
        {
            ...
            [
                ...
                {"name":"statisticsInterestCoupon","text":"优惠券列表","link":"/","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN'"},
                ...
                {"name":"autumn","text":"活动列表","link":"/","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN'"}
            ]
        },
        {
...
<head>
    ...
    <link href="/activity-console/style/libs/bootstrap/bootstrap-datetimepicker/bootstrap-datetimepicker.css"
          rel="stylesheet">
    ...
    <#if pageCss?? && pageCss != "">
        <link rel="stylesheet" type="text/css" href="${applicationContext}/activity-console/style/dest/${pageCss}"
              charset="utf-8"/>
    </#if>
