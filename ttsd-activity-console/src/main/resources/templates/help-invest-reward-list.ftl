...
<div class="col-md-10">
    ...
    <form action="/activity-console/activity-manage/invite-help/invest-reward-list" class="form-inline query-build"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control jq-balance-min" name="minxInvest" value="${minxInvest!}" onblur="this.value=this.value.replace(/\D/g,'')" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">~
