...
<@global.main pageCss="" pageJavascript="luxury-prize.js" headLab="activity-manage" sideLab="" title="旅游+奢侈品活动管理">
...
<div class="col-md-10">
    ...
    <form action="/activity-console/activity-manage/travel/user-luxury-list" class="form-inline query-build" method="get">
