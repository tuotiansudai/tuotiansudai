...
<@global.main pageCss="" pageJavascript="user-luxury-list.js" headLab="activity-manage" sideLab="travelLuxuryActivity" title="旅游+奢侈品活动管理">
...
<div class="col-md-10">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <a class="btn btn-default btn-primary" href="/activity-console/activity-manage/luxury/user-luxury-list" role="button">奢侈品获奖记录</a>
            <a class="btn btn-default" href="/activity-console/activity-manage/luxury/luxury-prize-list" role="button">奢侈品更新</a>
        </div>
    </div>

    <form action="/activity-console/activity-manage/luxury/user-luxury-list" class="form-inline query-build" method="get">
