...
<div class="col-md-10">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <a class="btn btn-default btn-primary" href="/activity-console/activity-manage/user-prize-list"
               role="button">抽奖记录</a>
        </div>
    </div>

    <div class="table-responsive">
        <form action="/activity-console/activity-manage/user-prize-list" method="get" class="form-inline query-build"
              id="prizeFrom">
            ...
            <div class="form-group" id="autumnPrizeDiv">
                ...
                <select class="selectpicker" name="selectPrize">
                    ...
                    <#list lotteryPrizes as prize>
                        <option value="${prize.lotteryPrize}"
                                <#if lotteryPrizes?? && prize.lotteryPrize==selectPrize>selected</#if>>
