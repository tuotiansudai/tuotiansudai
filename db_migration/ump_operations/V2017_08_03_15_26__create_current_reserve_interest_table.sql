CREATE TABLE `ump_operations`.`current_loan_out_transfer_reserve_request` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_CURRENT_LOAN_OUT_TRANSFER_RESERVE_REQUEST_ORDER_ID` (`order_id`)
)
  ENGINE = InnoDB
  AUTO_INCREMENT = 100001
  DEFAULT CHARSET = utf8;

CREATE TABLE `ump_operations`.`current_loan_out_transfer_reserve_response` (
  `id`             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT FK_CURRENT_LOAN_OUT_TRANSFER_RESERVE_RESPONSE_ID_REF_REQUEST_ID FOREIGN KEY (`request_id`) REFERENCES `ump_operations`.`current_loan_out_transfer_reserve_request` (`id`)
)
  ENGINE = InnoDB
  AUTO_INCREMENT = 100001
  DEFAULT CHARSET = utf8;

CREATE TABLE `ump_operations`.`current_loan_out_transfer_reserve_notify_request` (
  `id`             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  `response_data`  TEXT,
  PRIMARY KEY (`id`),
  KEY `IDX_CURRENT_LOAN_OUT_TRANSFER_RESERVE_NOTIFY_REQUEST_ORDER_ID` (`order_id`)
)
  ENGINE = InnoDB
  AUTO_INCREMENT = 100001
  DEFAULT CHARSET = utf8;