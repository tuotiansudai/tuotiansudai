...
CREATE TABLE `aa`.`membership` (
  ...
  insert into `aa`.`membership` value(1,'V1','','0.1');
  insert into `aa`.`membership` value(2,'V2','','0.1');
  insert into `aa`.`membership` value(3,'V3','','0.1');
  insert into `aa`.`membership` value(4,'V4','','0.1');
  insert into `aa`.`membership` value(5,'V5','','0.1');
