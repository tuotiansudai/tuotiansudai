...
update user set experience_balance = experience_balance+2007700 where login_name = '0mulq6Wb';

update user set experience_balance = experience_balance+999300 where login_name = '6fSC0Sbv';

update user set experience_balance = experience_balance+8000000 where login_name = 'baizhuying';

update user set experience_balance = experience_balance+1000000 where login_name = 'ELYU05Of';

update user set experience_balance = experience_balance+8000000 where login_name = 'g7W1SoLl';

update user set experience_balance = experience_balance+500000 where login_name = 'g9LRJNeI';

update user set experience_balance = experience_balance+1094800 where login_name = 'Lixiaodong';

update user set experience_balance = experience_balance+2500000 where login_name = 'NVBdCbqs';

update user set experience_balance = experience_balance+1000000 where login_name = 'QFbBa64b';

update user set experience_balance = experience_balance+800000 where login_name = 'QLS7A8ch';

update user set experience_balance = experience_balance+500200 where login_name = 'rqkql';

update user set experience_balance = experience_balance+1047500 where login_name = 'Rs8KUjDC';

update user set experience_balance = experience_balance+761700 where login_name = 'ry0309';

update user set experience_balance = experience_balance+550000 where login_name = 'SEW5pxAQ';

update user set experience_balance = experience_balance+2500000 where login_name = 'suKxZdYS';

update user set experience_balance = experience_balance+2500600 where login_name = 'ttrqguorui';

update user set experience_balance = experience_balance+1140400 where login_name = 'ttrqwangyaning';

update user set experience_balance = experience_balance+4000000 where login_name = 'uEwK2oNS';

update user set experience_balance = experience_balance+600000 where login_name = 'VzWWCbQl';

update user set experience_balance = experience_balance+1000000 where login_name = 'x7DDtik5';

update user set experience_balance = experience_balance+70202700 where login_name = 'y3r9e2t5';
