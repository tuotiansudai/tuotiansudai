...
多重保障：资金银行存管、抵押模式、严格风控体系、平台信息透明、数据信息安全等保障；服务费折扣：平台向V0、V1会员收取利息的10%作为服务费，V2收取9%，V3、V4收取8%，V5仅收取7%；贵宾专线：贵宾级客服服务，投资问题，意见建议专享直达专享；理财顾问：发标时间，平台活动，投资顾问第一时间通知到您；生日福利：V5专享，平台将会在会员生日时送上神秘礼包。注：会员权益会不断提升，敬请期待。'  WHERE category='会员有哪些特权？' and title='会员有哪些特权？';
