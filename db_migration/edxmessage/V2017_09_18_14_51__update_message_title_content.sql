...
SET title  = '6888元体验金已存入您的账户，请查收！',
  ...
  template_text = '哇，您终于来啦！初次见面，岂能无礼？6888元体验金及668元现金红包双手奉上，快去投资吧！'
...
SET title  = '恭喜您成功投资{0}元',
  ...
  template_text = '尊敬的用户，您已成功投资房产/车辆抵押借款{0}元，独乐不如众乐，马上【邀请好友投资】还能额外拿0.5%现金奖励哦！',
...
SET title  = '您投资的{0}提前还款，{1}元已返还至您的账户！',
  ...
  template_text = '尊敬的用户，您在{0}投资的房产/车辆抵押借款因借款人放弃借款而提前终止，您的收益与本金已返还至您的账户，您可以【看看其他优质项目】',
...
SET title  = '您发起的转让项目转让成功，{0}元已发放至您的账户！',
  ...
  template_text = '尊敬的用户，您发起的转让项目{0}已经转让成功，资金已经到达您的账户，感谢您选择拓天速贷。'
