    ...
    <div class="con">
        <div class="bg-con">
            <div class="active-box">
                ...
                <p> 3、实物类奖品中奖后，由客服确认用户投递地址，以物流及快递时间为准，实物投递仅限于中国大陆地区，不含港澳台地区，新疆、青海、西藏不包邮费，用户如需奖励，自行承担物流及快递费用。</p>
                <p> 4、用户抽奖次数只限当日有效。</p>
                <p> 5、新手投资：新手标抽奖用户只要投资新手标，即可获取一次抽奖机会，投资资金无限制。</p>
                <p> 普通投资：投资抽奖用户投资除新手标以外的任何标的物均可抽奖，用户单笔投资500元可获取一次，用户单笔投资1500元以上可获取三次机会（单日最高3次）。</p>
            </div>
            <div class="item-box">
                <div class="tab">
