...
/*     */ {
/*  58 */   private static Map<String, String> entityEscapeMap = new HashMap();
/*  59 */   private static Map<String, String> escapeEntityMap = new HashMap();
/*     */ 
/*     */   public static String escape(String original)
/*     */   {
/*   9 */     StringBuffer buf = new StringBuffer(original);
/*  10 */     escape(buf);
...
/*  15 */     int index = 0;
/*     */ 
/*  17 */     while (index < original.length()) {
/*  18 */       String escaped = (String)entityEscapeMap.get(original.substring(index, index + 1));
/*  19 */       if (null != escaped) {
/*  20 */         original.replace(index, index + 1, escaped);
/*  21 */         index += escaped.length();
/*     */       } else {
/*  23 */         index++;
/*     */       }
/*     */     }
...
/*  29 */     StringBuffer buf = new StringBuffer(original);
/*  30 */     unescape(buf);
...
/*  35 */     int index = 0;
/*  36 */     int semicolonIndex = 0;
/*     */ 
/*  39 */     while (index < original.length()) {
/*  40 */       index = original.indexOf("&", index);
/*  41 */       if (-1 == index) {
/*     */         break;
/*     */       }
/*  44 */       semicolonIndex = original.indexOf(";", index);
/*  45 */       if ((-1 == semicolonIndex) || (10 <= semicolonIndex - index)) break;
/*  46 */       String escaped = original.substring(index, semicolonIndex + 1);
/*  47 */       String entity = (String)escapeEntityMap.get(escaped);
/*  48 */       if (null != entity) {
/*  49 */         original.replace(index, semicolonIndex + 1, entity);
/*     */       }
/*  51 */       index++;
/*     */     }
/*     */   }
