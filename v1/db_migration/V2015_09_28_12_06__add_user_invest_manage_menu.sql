...
/**增加客服角色**/
INSERT INTO `role` VALUES ('custorm_service','客服','客服') ON duplicate KEY UPDATE `name`=values(`name`),`description`=values(`description`);
...
INSERT INTO `role_permission` VALUES ('custorm_service', 'user_invest') ON duplicate KEY update role_id=values(role_id),permission_id=values(permission_id);
