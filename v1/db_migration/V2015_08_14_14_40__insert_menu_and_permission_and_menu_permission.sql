...
INSERT INTO `menu_permission` VALUES ('creditor_repay_plan_list','creditor_repay_plan_list') on duplicate key update `name`=values(`name`),description=values(description);
