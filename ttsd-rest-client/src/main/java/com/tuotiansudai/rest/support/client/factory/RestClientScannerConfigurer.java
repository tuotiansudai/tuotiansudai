...
public class RestClientScannerConfigurer implements BeanDefinitionRegistryPostProcessor, ApplicationContextAware {
    ...
    public RestClientScannerConfigurer(JacksonDecoder jacksonDecoder, JacksonEncoder jacksonEncoder, RestErrorDecoder restErrorDecoder, RequestHeaderInterceptor requestHeaderInterceptor) {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        RestClientScanner scanner = new RestClientScanner(registry, applicationContext, jacksonDecoder, jacksonEncoder, restErrorDecoder, requestHeaderInterceptor);
