<div class="nav-container">
    <div class="nav">
        ...
        <ul id="TopMainMenuList">
            ...
            <li><a href="${webServer}/loan-application" onclick="cnzzPush.trackClick('19顶部导航','新手指引')">我要借款</a></li>
            <li><a href="${webServer}/account" onclick="cnzzPush.trackClick('18顶部导航','我的账户')">我的账户</a></li>
            <li><a class="active" href="/">问答</a></li>
            <li><a href="${webServer}/about/company" onclick="cnzzPush.trackClick('20顶部导航','关于我们')">关于我们</a></li>
        </ul>
    </div>
</div>