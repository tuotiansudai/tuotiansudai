<div class="border-ask-box tc">
    <div class="pc-search-box clearfix" id="searchBoxTool">
        <form method="get" action="/question/search" class="clearfix">
            ...
            <a href="${applicationContext}/question" class="btn-normal want-question fl">我要提问</a>
        </form>
    ...
    <div class="mobile-menu">
        <a href="${applicationContext}/question" class="btn-main want-question">我要提问</a>
        <a href="${applicationContext}/question/my-questions" class="btn-main my-question">我的提问</a>
        <a href="${applicationContext}/answer/my-answers" class="btn-main my-answer">我的回答</a>
    </div>
