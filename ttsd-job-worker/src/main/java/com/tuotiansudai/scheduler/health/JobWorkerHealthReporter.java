package com.tuotiansudai.scheduler.health;

import com.tuotiansudai.client.RedisWrapperClient;
import com.tuotiansudai.scheduler.JobConfig;
...
@Component
public class JobWorkerHealthReporter extends HealthReporter {
    ...
    protected JobWorker getCurrentJobWorker() {
        return JobWorker.valueOf(JobConfig.workerName);
    }
