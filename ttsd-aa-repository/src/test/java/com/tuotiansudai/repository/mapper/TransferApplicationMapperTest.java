...
public class TransferApplicationMapperTest {
    ...
    public void shouldFindTransferApplicationListIsSuccess() {
        ...
        List<TransferApplicationRecordView> transferApplicationRecordDto = transferApplicationMapper.findTransferApplicationPaginationList(null, null, null, null, null, null, loanId, null, 0, 10);
    ...
    public void shouldFindTransferApplicationPaginationByLoginNameIsSuccess() {
        ...
        List<TransferApplicationRecordView> transferApplicationRecordDto = transferApplicationMapper.findTransferApplicationPaginationByLoginName(userModel.getLoginName(), Lists.newArrayList(TransferStatus.TRANSFERRING), 0, 10);
    ...
    public void shouldFindCountTransferApplicationPaginationIsSuccess() {
        ...
        List<TransferApplicationRecordView> transferApplicationRecordDto = transferApplicationMapper.findTransferApplicationPaginationList(null, null, null, null, null, transfereeInvestModel.getLoginName().length() > 10 ? "m" + transfereeInvestModel.getLoginName().substring(0, 10) : "m" + transfereeInvestModel.getLoginName(), null, null, 0, 1);
        assertNotNull(transferApplicationRecordDto.get(0));
        assertEquals("name", transferApplicationRecordDto.get(0).getName());
        assertEquals(1000, transferApplicationRecordDto.get(0).getTransferAmount());
        assertEquals(1200, transferApplicationRecordDto.get(0).getInvestAmount());
    ...
    private UserModel createUserByUserId(String userId) {
        ...
        userModelTest.setMobile(userId.length() > 10 ? "m" + userId.substring(0, 10) : "m" + userId);
