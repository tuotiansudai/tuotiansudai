...
public interface ReferrerManageMapper {
    ...
    int findReferrerManageCount(@Param("referrerMobile") String referrerMobile,
                                @Param("investMobile") String investMobile,
                                @Param("investStartTime") Date investStartTime,
                                @Param("investEndTime") Date investEndTime,
                                @Param("level") Integer level,
                                @Param("rewardStartTime") Date rewardStartTime,
                                @Param("rewardEndTime") Date rewardEndTime,
                                @Param("role") Role role,
                                @Param("source") Source source);

    long findReferrerManageInvestAmountSum(@Param("referrerMobile") String referrerMobile,
                                           @Param("investMobile") String investMobile,
                                           @Param("investStartTime") Date investStartTime,
                                           @Param("investEndTime") Date investEndTime,
                                           @Param("level") Integer level,
    ...
    long findReferrerManageRewardAmountSum(@Param("referrerMobile") String referrerMobile,
                                           @Param("investMobile") String investMobile,
                                           @Param("investStartTime") Date investStartTime,
                                           @Param("investEndTime") Date investEndTime,
                                           @Param("level") Integer level,
    ...
    List<ReferrerManageView> findReferrerManage(@Param("referrerMobile") String referrerMobile,
                                                @Param("investMobile") String investMobile,
                                                @Param("investStartTime") Date investStartTime,
                                                @Param("investEndTime") Date investEndTime,
                                                @Param("level") Integer level,
