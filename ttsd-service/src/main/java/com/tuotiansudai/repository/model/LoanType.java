...
public enum LoanType {
    ...
    LOAN_TYPE_3("interest_begin_on_invest","day","先付利息后还本金，按天计息，放款后生息","1","month","rfcl","先付利息后还本金，按天计息，放款后生息"),
    LOAN_TYPE_4("interest_begin_on_invest","day","到期还本付息，按天计息，放款后生息","1","day","rlio","到期还本付息，按天计息，放款后生息"),
