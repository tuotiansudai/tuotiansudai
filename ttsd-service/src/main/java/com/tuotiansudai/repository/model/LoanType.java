...
public enum LoanType {
    ...
    // LOAN_TYPE_1
    INVEST_INTEREST_MONTHLY_REPAY("先付利息后还本金，按天计息，即投即生息", InterestInitiateType.INTEREST_START_AT_INVEST, LoanPeriodUnit.MONTH),

    // LOAN_TYPE_3
    LOAN_INTEREST_MONTHLY_REPAY("先付利息后还本金，按天计息，放款后生息", InterestInitiateType.INTEREST_START_AT_LOAN, LoanPeriodUnit.MONTH),
