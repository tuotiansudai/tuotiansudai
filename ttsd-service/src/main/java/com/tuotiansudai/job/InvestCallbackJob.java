...
public class InvestCallbackJob implements Job {
    ...
    public static final String INVEST_JOB_TRIGGER_KEY = "job:invest:invest_callback_job_trigger";
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        String trigger = redisWrapperClient.get(INVEST_JOB_TRIGGER_KEY);
