...
public class AutoJPushLotteryObtainCashAlertJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        String loginName = (String) context.getJobDetail().getJobDataMap().get(LOTTERY_OBTAIN_CASH_ID_KEY);
        jPushAlertService.autoJPushLotteryLotteryObtainCashAlert(loginName);
        logger.debug("trigger send jPush alert lottery obtain job, lognName : " + loginName);
