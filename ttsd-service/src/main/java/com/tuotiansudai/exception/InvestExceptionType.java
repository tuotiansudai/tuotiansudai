...
public enum InvestExceptionType {
    ...
    MORE_THAN_MAX_INVEST_AMOUNT("出借金额超过了用户出借限额"),
    LOAN_IS_FULL("标的已满"),
    EXCEED_MONEY_NEED_RAISED("标的可投金额不足"),
    ILLEGAL_INVEST_AMOUNT("出借金额不符合递增金额要求"),
    LESS_THAN_MIN_INVEST_AMOUNT("出借金额小于标的最小出借金额"),
    OUT_OF_NOVICE_INVEST_LIMIT("新手标出借已超上限"),
    PASSWORD_INVEST_OFF("尚未开启免密出借"),
    ILLEGAL_LOAN_STATUS("标的暂不可出借"),
