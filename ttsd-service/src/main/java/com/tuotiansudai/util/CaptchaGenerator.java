...
public class CaptchaGenerator {
    ...
    public static Captcha generate(int captchaWidth, int captchaHeight) {
        ...
        CaptureDefaultWordRenderer wordRenderer = new CaptureDefaultWordRenderer(Lists.newArrayList(new Color(15,61,112)), Lists.newArrayList(new Font(Font.SANS_SERIF, Font.PLAIN, 24),new Font(Font.SANS_SERIF, Font.ITALIC, 24)));
        NumbersAnswerProducer numbersAnswerProducer = new NumbersAnswerProducer(4);
