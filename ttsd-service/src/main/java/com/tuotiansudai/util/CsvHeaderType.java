...
public enum CsvHeaderType {
    ...
    SystemBillHeader("序号,时间,费用类型,操作hao类型,金额(元),费用详情", "系统账户查询"),
    TransferListHeader("编号,原始项目,转让人,转让价格(元),剩余期限,转让状态, 转让发起时间,承接人,转让手续费(元)", "所有的转让项目"),
    LoanRepayHeader("项目编号,项目名称,还款人,预计还款日期,实际还款日期,当前日期,应还本金(元),应还利息(元),应还总数(元),转让手续费(元)", "所有的转让项目"),
