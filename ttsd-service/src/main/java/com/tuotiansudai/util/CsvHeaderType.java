...
public enum CsvHeaderType {
    ...
    ConsoleInvests("项目编号,项目名称,期数,投资人,业务员,姓名,手机号,生日,省,市,推荐人,业务员,姓名,手机号,渠道,来源,投资时间,自动投标,投资金额,加息利率（%）/预期收益（元）/实发收益（元）,投资状态", "后台用户投资记录"),
    ...
    Goods("商品类别,当前顺序,名称,商品介绍,总数量,已兑换数量,商品价格,商品有效期限,状态", "商品导出");
