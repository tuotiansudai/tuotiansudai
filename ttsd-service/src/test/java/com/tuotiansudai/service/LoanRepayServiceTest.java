...
public class LoanRepayServiceTest {
    ...
    public void shouldSendLoanRepayNotifySms() {
        ...
        LoanRepayNotifyModel repayNotifyModel2 = this.getFakeLoanRepayNotify(200000, "loginName2", "13922222222", 222222222);
    ...
    private LoanRepayNotifyModel getFakeLoanRepayNotify(long repayAmount, String loanName, String mobile, long loanId) {
        LoanRepayNotifyModel repayNotify = new LoanRepayNotifyModel();
        repayNotify.setLoanId(loanId);
