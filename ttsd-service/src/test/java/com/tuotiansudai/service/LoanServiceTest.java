...
public class LoanServiceTest {
    ...
    public void shouldShowEncryptLoginNameWhenAnonymousAndExcludeShowRandomLoginNameList() {
        ...
        assertEquals(fakeUser.getMobile().substring(0,3)+"****"+fakeUser.getMobile().substring(7), randomUtils.encryptMobileForCurrentLoginName("", investModel1.getLoginName(), investModel1.getId(),Source.WEB));
    }
    ...
    public void shouldShowEncryptLoginNameWhenAnonymousAndIncludeShowRandomLoginNameList() {
        ...
        assertEquals(fakeUser.getMobile().substring(0,3) + "****", randomUtils.encryptMobileForCurrentLoginName("", investModel1.getLoginName(), investModel1.getId(),Source.WEB).substring(0,7));
    }
    ...
    public void shouldShowEncryptLoginNameWhenLoginNameSameAsInvestorLoginName() {
        ...
        assertEquals(fakeUser.getMobile().substring(0,3)+"****"+fakeUser.getMobile().substring(7), randomUtils.encryptMobileForCurrentLoginName(userModel.getLoginName(), investModel1.getLoginName(), investModel1.getId(),Source.WEB));
    }
    ...
    public void shouldShowEncryptLoginNameWhenLoginNameNotSameAsInvestorLoginNameAndIncludeShowRandomLoginNameList() {
        ...
        investModel1.setLoginName(fakeUser.getLoginName());
        investModel1.setId(1000002L);
        assertEquals(fakeUser.getMobile().substring(0, 3)+"****", randomUtils.encryptMobileForCurrentLoginName("loginName2", investModel1.getLoginName(), investModel1.getId(),Source.WEB).substring(0,7));
    }
    ...
    public void shouldShowEncryptLoginNameWhenLoginNameNotSameAsInvestorLoginNameAndExcludeShowRandomLoginNameList() {
        ...
        assertEquals(fakeUser.getMobile().substring(0,3)+"****" + fakeUser.getMobile().substring(7), randomUtils.encryptMobileForCurrentLoginName(userModel2.getLoginName(), investModel1.getLoginName(), investModel1.getId(),Source.WEB));
    }
