...
//        assert (userTianDouRecordDto.getPrize() == TianDouPrize.InterestCoupon5);
        ...
        assert (userTianDouRecordDto.getLoginName().equals(randomUtils.encryptMobileForCurrentLoginName("", loginName, Source.WEB)));
    }
    ...
    public void shouldDrawPrizeSuccessMultiTimes() {
        ...
        assert (userTianDouRecordDto1_0.getLoginName().equals(randomUtils.encryptMobileForCurrentLoginName("", loginName1,Source.WEB)));

        UserTianDouRecordDto userTianDouRecordDto1_1 = otherList.get(1);
        assert (userTianDouRecordDto1_1.getLoginName().equals(randomUtils.encryptMobileForCurrentLoginName("", loginName1,Source.WEB)));

        UserTianDouRecordDto userTianDouRecordDto1_2 = otherList.get(2);
        assert (userTianDouRecordDto1_2.getLoginName().equals(randomUtils.encryptMobileForCurrentLoginName("", loginName1,Source.WEB)));

        UserTianDouRecordDto userTianDouRecordDto1_3 = otherList.get(3);
        assert (userTianDouRecordDto1_3.getLoginName().equals(randomUtils.encryptMobileForCurrentLoginName("", loginName1,Source.WEB)));
    }
