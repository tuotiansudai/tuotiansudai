...
public class FinanceReportMapperTest {
    ...
    public void testFindFinanceReportViews() throws Exception {
        ...
        List<FinanceReportItemView> financeReportItemViews = financeReportMapper.findFinanceReportViews(null, null, null, null, null, 0, 100);
        assertEquals(originalFinanceReportItemViewList.size(), financeReportItemViews.size());

        financeReportItemViews = financeReportMapper.findFinanceReportViews(1000L, null, null, null, null, 0, 100);
        ...
        financeReportItemViews = financeReportMapper.findFinanceReportViews(null, 2, null, null, null, 0, 100);
        assertEquals(2, financeReportItemViews.size());
        for (FinanceReportItemView financeReportItemView : financeReportItemViews) {
            assertEquals(2, financeReportItemView.getPeriod());
        }
        financeReportItemViews = financeReportMapper.findFinanceReportViews(null, 1, null, null, null, 0, 100);
        assertEquals(4, financeReportItemViews.size());
        for (FinanceReportItemView financeReportItemView : financeReportItemViews) {
            assertEquals(1, financeReportItemView.getPeriod());
        }

        financeReportItemViews = financeReportMapper.findFinanceReportViews(null, null, "investorWithReferrer", null, null, 0, 100);
        assertEquals(6, financeReportItemViews.size());
        for (FinanceReportItemView financeReportItemView : financeReportItemViews) {
            assertEquals("investorWithReferrer", financeReportItemView.getInvestLoginName());
        }

        financeReportItemViews = financeReportMapper.findFinanceReportViews(null, null, null, DateTime.parse("2016-11-12T00:20").toDate(), null, 0, 100);
        assertEquals(2, financeReportItemViews.size());
        for (FinanceReportItemView financeReportItemView : financeReportItemViews) {
            assertTrue(financeReportItemView.getInvestTime().after(DateTime.parse("2016-11-12T00:20").toDate()));
        }

        financeReportItemViews = financeReportMapper.findFinanceReportViews(null, null, null, null, DateTime.parse("2016-10-12T02:20").toDate(), 0, 100);
        assertEquals(6, financeReportItemViews.size());
        for (FinanceReportItemView financeReportItemView : financeReportItemViews) {
            assertTrue(financeReportItemView.getInvestTime().before(DateTime.parse("2016-10-12T02:20").toDate()));
        }

        financeReportItemViews = financeReportMapper.findFinanceReportViews(null, null, null, DateTime.parse("2016-10-12T00:20").toDate(), DateTime.parse("2016-11-12T02:20").toDate(), 0, 100);
        ...
        financeReportItemViews = financeReportMapper.findFinanceReportViews(1000L, 1, "investorWithReferrer", null, null, 0, 100);
        ...
        financeReportItemViews = financeReportMapper.findFinanceReportViews(1000L, 1, "investorWithReferrer", DateTime.parse("2016-11-12T00:20").toDate(), null, 0, 100);
        assertEquals(0, financeReportItemViews.size());
        financeReportItemViews = financeReportMapper.findFinanceReportViews(1000L, 5, null, null, null, 0, 100);
        assertEquals(0, financeReportItemViews.size());
        financeReportItemViews = financeReportMapper.findFinanceReportViews(3L, null, "user", null, null, 0, 100);
        assertEquals(0, financeReportItemViews.size());
        financeReportItemViews = financeReportMapper.findFinanceReportViews(1000L, 2, "investorWithoutReferrer", null, null, 0, 100);
        assertEquals(0, financeReportItemViews.size());
    }
    ...
    public void testFindCountFinanceReportViews() throws Exception {
        List<FinanceReportItemView> originalFinanceReportItemViewList = prepareData();
        assertEquals(originalFinanceReportItemViewList.size(), financeReportMapper.findCountFinanceReportViews(null, null, null, null, null));
        assertEquals(4, financeReportMapper.findCountFinanceReportViews(1000L, null, null, null, null));
        assertEquals(2, financeReportMapper.findCountFinanceReportViews(null, 2, null, null, null));
        assertEquals(4, financeReportMapper.findCountFinanceReportViews(null, 1, null, null, null));
        assertEquals(6, financeReportMapper.findCountFinanceReportViews(null, null, "investorWithReferrer", null, null));
        assertEquals(2, financeReportMapper.findCountFinanceReportViews(null, null, null, DateTime.parse("2016-11-12T00:20").toDate(), null));
        assertEquals(6, financeReportMapper.findCountFinanceReportViews(null, null, null, null, DateTime.parse("2016-10-12T02:20").toDate()));
        assertEquals(8, financeReportMapper.findCountFinanceReportViews(null, null, null, DateTime.parse("2016-10-12T00:20").toDate(), DateTime.parse("2016-11-12T02:20").toDate()));
        assertEquals(1, financeReportMapper.findCountFinanceReportViews(1000L, 1, "investorWithReferrer", null, null));

        assertEquals(0, financeReportMapper.findCountFinanceReportViews(1000L, 1, "investorWithReferrer", DateTime.parse("2016-11-12T00:20").toDate(), null));
        assertEquals(0, financeReportMapper.findCountFinanceReportViews(1000L, 5, null, null, null));
        assertEquals(0, financeReportMapper.findCountFinanceReportViews(3L, null, "user", null, null));
        assertEquals(0, financeReportMapper.findCountFinanceReportViews(1000L, 2, "investorWithoutReferrer", null, null));
    }
}
