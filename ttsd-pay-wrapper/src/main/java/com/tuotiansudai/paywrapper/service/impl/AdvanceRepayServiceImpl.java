...
public class AdvanceRepayServiceImpl implements AdvanceRepayService {
    ...
    public String repayCallback(Map<String, String> paramsMap, String originalQueryString) throws Exception {
        ...
        logger.info(MessageFormat.format("[Advance Repay {0} publish message RepaySuccess]", String.valueOf(loanRepayId)));
        RepaySuccessMessage repaySuccessMessage = new RepaySuccessMessage(loanRepayId, true);
        try {
