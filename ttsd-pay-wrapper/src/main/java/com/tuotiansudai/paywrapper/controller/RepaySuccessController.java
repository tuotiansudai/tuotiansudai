...
public class RepaySuccessController {
    ...
    public BaseDto<PayDataDto> asyncInvestRepay(@Valid @RequestBody RepayMqNotifyDto repayDto) {
    ...
    public BaseDto<PayDataDto> asyncExtraRepay(@Valid @RequestBody RepayMqNotifyDto repayDto) {
    ...
    public BaseDto<PayDataDto> payBackInvest(@Valid @RequestBody RepayMqNotifyDto repayDto) {
