...
public class JobController {
    ...
    public BaseDto<PayDataDto> asyncInvestNotify(@RequestBody String investNotifyRequestId) {
        return this.investService.asyncInvestCallback(investNotifyRequestId);
    }
