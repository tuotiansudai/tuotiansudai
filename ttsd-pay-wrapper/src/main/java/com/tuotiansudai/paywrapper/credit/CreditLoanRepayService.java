...
public class CreditLoanRepayService {
    ...
    static Logger logger = Logger.getLogger(CreditLoanRepayService.class);
    ...
    @Transactional
    public BaseDto<PayFormDataDto> passwordRepay(String mobile) {
        AccountModel transfereeAccount = accountMapper.findByMobile(mobile);
