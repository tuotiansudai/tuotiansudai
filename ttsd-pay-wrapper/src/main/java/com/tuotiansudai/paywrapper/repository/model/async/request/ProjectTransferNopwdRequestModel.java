...
public class ProjectTransferNopwdRequestModel extends BaseAsyncRequestModel {
    ...
    public static ProjectTransferNopwdRequestModel newHuiZuRepayNopwdRequest(String orderId, String userId, String amount) {
        return new ProjectTransferNopwdRequestModel(ETCDConfigReader.getValue("credit.loan"), orderId, userId, amount, Source.HUI_ZU, UmPayServType.TRANSFER_IN_TRANSFER, UmPayParticType.INVESTOR, AsyncUmPayService.HUI_ZU_NO_PASSWORD_REPAY_PROJECT_TRANSFER);
    }
