...
import com.tuotiansudai.paywrapper.repository.model.ExtraRateNotifyProcessStatus;
...
public interface ExtraRateNotifyRequestMapper extends BaseCallbackMapper {
    ...
    void updateStatus(@Param(value = "id") Long id, @Param(value = "status") ExtraRateNotifyProcessStatus status);
}
