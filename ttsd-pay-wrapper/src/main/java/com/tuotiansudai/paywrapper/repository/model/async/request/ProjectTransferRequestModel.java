...
public class ProjectTransferRequestModel extends BaseAsyncRequestModel {
    ...
    public static ProjectTransferRequestModel newPayBackRequest(String projectId, String orderId, String userId, String amount) {
        ...
        model.notifyUrl = MessageFormat.format("{0}/callback/{1}", CALLBACK_HOST_PROPS.get("ump.callback.back.host"), "pay_back_notify");
