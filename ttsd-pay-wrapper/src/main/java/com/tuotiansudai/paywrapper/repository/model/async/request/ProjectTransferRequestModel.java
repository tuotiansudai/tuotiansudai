...
public class ProjectTransferRequestModel extends BaseAsyncRequestModel {
    ...
    public static ProjectTransferRequestModel newHuiZuRepayPasswordRequest(String orderId, String userId, String amount) {
        ProjectTransferRequestModel model = new ProjectTransferRequestModel(ETCDConfigReader.getValue("credit.loan"), orderId, userId, amount, UmPayParticAccType.INDIVIDUAL, Source.MOBILE, AsyncUmPayService.HUI_ZU_PASSWORD_REPAY_PROJECT_TRANSFER);
        model.servType = UmPayServType.TRANSFER_IN_TRANSFER.getCode();
        model.transAction = UmPayTransAction.IN.getCode();
        model.particType = UmPayParticType.INVESTOR.getCode();
        return model;
    ...
    public static ProjectTransferRequestModel newCreditLoanActivateAccountRequest(String orderId, String userId, String amount) {
        ProjectTransferRequestModel model = new ProjectTransferRequestModel(ETCDConfigReader.getValue("credit.loan"), orderId, userId, amount, UmPayParticAccType.INDIVIDUAL, Source.MOBILE, AsyncUmPayService.CREDIT_LOAN_ACTIVATE_ACCOUNT_PROJECT_TRANSFER);
        model.servType = UmPayServType.TRANSFER_IN_TRANSFER.getCode();
        model.transAction = UmPayTransAction.IN.getCode();
        model.particType = UmPayParticType.INVESTOR.getCode();
        return model;
    ...
    public static ProjectTransferRequestModel newCreditLoanRechargePwdRequest(String orderId, String userId, String amount) {
        ProjectTransferRequestModel model = new ProjectTransferRequestModel(ETCDConfigReader.getValue("credit.loan"), orderId, userId, amount, UmPayParticAccType.INDIVIDUAL, Source.WEB, AsyncUmPayService.CREDIT_LOAN_RECHARGE_TRANSFER);
        model.servType = UmPayServType.TRANSFER_IN_TRANSFER.getCode();
        model.transAction = UmPayTransAction.IN.getCode();
        model.particType = UmPayParticType.INVESTOR.getCode();
        model.setRetUrl(MessageFormat.format("{0}/{1}", ETCDConfigReader.getValue("pay.callback.console.host"), AsyncUmPayService.CREDIT_LOAN_RECHARGE_TRANSFER.getWebRetCallbackPath()));
        return model;
    }

    public static ProjectTransferRequestModel newCreditLoanOutRequest(String orderId, String userId, String amount) {
        ProjectTransferRequestModel model = new ProjectTransferRequestModel(ETCDConfigReader.getValue("credit.loan"), orderId, userId, amount, UmPayParticAccType.INDIVIDUAL, Source.WEB, AsyncUmPayService.CREDIT_LOAN_OUT_PROJECT_TRANSFER);
        model.servType = UmPayServType.TRANSFER_OUT_TRANSFER.getCode();
        model.transAction = UmPayTransAction.OUT.getCode();
        model.particType = UmPayParticType.INVESTOR.getCode();
        return model;
    ...
    public static ProjectTransferRequestModel newCreditLoanRepayRequest(String orderId, String userId, String amount) {
        ProjectTransferRequestModel model = new ProjectTransferRequestModel(ETCDConfigReader.getValue("credit.loan"), orderId, userId, amount, UmPayParticAccType.INDIVIDUAL, Source.MOBILE, AsyncUmPayService.CREDIT_LOAN_REPAY_PROJECT_TRANSFER);
        model.servType = UmPayServType.TRANSFER_IN_TRANSFER.getCode();
        model.transAction = UmPayTransAction.IN.getCode();
        model.particType = UmPayParticType.INVESTOR.getCode();
        return model;
    ...
    public static ProjectTransferRequestModel newCreditLoanTransferAgentRequest(String orderId, String userId, String amount) {
        ProjectTransferRequestModel model = new ProjectTransferRequestModel(ETCDConfigReader.getValue("credit.loan"), orderId, userId, amount, UmPayParticAccType.INDIVIDUAL, Source.WEB, AsyncUmPayService.CREDIT_LOAN_AGENT_TRANSFER);
        model.servType = UmPayServType.TRANSFER_OUT_TRANSFER.getCode();
        model.transAction = UmPayTransAction.OUT.getCode();
        model.particType = UmPayParticType.INVESTOR.getCode();
        return model;
