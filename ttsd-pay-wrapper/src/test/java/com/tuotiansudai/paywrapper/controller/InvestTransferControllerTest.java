...
public class InvestTransferControllerTest {
    ...
    public void overInvestPaybackSuccess() throws Exception {
        ...
        InvestModel fakeTransferInvest = this.createFakeInvest(fakeLoan.getId(), null, 1000000, transferrer.getLoginName(), InvestStatus.SUCCESS, TransferStatus.TRANSFERRING);
        ...
        List<InvestModel> investModelList2 = investMapper.findPaginationByLoginName(transferee2.getLoginName(), 0, Integer.MAX_VALUE);
    ...
    private InvestModel createFakeInvest(long loanId, Long transferInvestId, long amount, String loginName, InvestStatus investStatus, TransferStatus transferStatus) {
        InvestModel fakeInvestModel = new InvestModel(IdGenerator.generate(), loanId, transferInvestId, loginName, amount, 0.1, false, new Date(), Source.WEB, null);
