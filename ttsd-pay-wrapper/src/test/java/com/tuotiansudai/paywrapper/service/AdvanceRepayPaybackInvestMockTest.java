...
@ActiveProfiles("test")
@ContextConfiguration(locations = {"classpath:applicationContext.xml"})public class AdvanceRepayPaybackInvestMockTest {
    ...
    @Test
    public void shouldLastPeriodWhenInvestRepayIsComplete() throws Exception{
        long loanId = 1;
        ...
        InvestRepayModel invest2InvestRepay2 = new InvestRepayModel(1, invest2.getId(), 1, invest2.getAmount(), 6, 1, loanRepay1.getRepayDate(), RepayStatus.COMPLETE);
        ...
        assertTrue(advanceRepayService.paybackInvest(loanRepay2.getId()));
