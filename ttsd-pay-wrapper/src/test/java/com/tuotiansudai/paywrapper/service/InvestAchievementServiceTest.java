...
public class InvestAchievementServiceTest {
    ...
    public void shouldAwardFirstInvestAchievement() throws Exception {
        ...
        InvestModel investModel = new InvestModel(fakeLoan.getId(), 1, investor.getLoginName(), Source.WEB, null);
    ...
    public void shouldNotAwardFirstInvestAchievementWhenInvestHasMoreThanThreeTimesFirstInvestOnThisMonth() throws Exception {
        ...
        InvestModel loan4InvestModel1 = new InvestModel(fakeLoan4.getId(), 1, investor1.getLoginName(), Source.WEB, null);
        loan4InvestModel1.setId(idGenerator.generate());
        ...
        InvestModel loan4InvestModel2 = new InvestModel(fakeLoan4.getId(), 1, investor2.getLoginName(), Source.WEB, null);
        loan4InvestModel2.setId(idGenerator.generate());
