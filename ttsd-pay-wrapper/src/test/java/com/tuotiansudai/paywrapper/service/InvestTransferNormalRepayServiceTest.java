...
public class InvestTransferNormalRepayServiceTest {
    ...
    private TransferApplicationModel createFakeTransferApplication(InvestModel transferInvestModel, Long investId, int period, long transferAmount, long transferFee, Date transferTime, TransferStatus transferStatus) {
        TransferApplicationModel fakeTransferApplication = new TransferApplicationModel(transferInvestModel, "name", period, transferAmount, transferFee, new DateTime().plusDays(1).toDate(),30);
