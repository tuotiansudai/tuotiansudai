...
public class CreditLoanPasswordRepayServiceTest {
    ...
    public void shouldLoanRepayCallbackSuccess() throws Exception {
        ...
        assertThat(((AmountTransferMultiMessage)messageCaptor.getAllValues().get(1)).getMessageList().get(0).getTransferType(), is(TransferType.TRANSFER_OUT_BALANCE));
        ...
        assertThat(((AmountTransferMultiMessage)messageCaptor.getAllValues().get(1)).getMessageList().get(0).getBusinessType(), is(UserBillBusinessType.CREDIT_LOAN_REPAY));
