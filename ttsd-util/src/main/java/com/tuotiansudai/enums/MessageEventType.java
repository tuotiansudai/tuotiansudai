...
public enum MessageEventType {
    REGISTER_USER_SUCCESS("注册成功", "6888元体验金已存入您的账户，请查收！", "哇，您终于来啦！初次见面，岂能无礼？6888元体验金及1000元投资红包双手奉上，快去投资吧！"),
    NEWMAN_TYRANT("新贵富豪争霸赛", "恭喜您获得活动奖励5888元体验金！", "{0}您在“新贵富豪争霸赛”活动中获得胜利，奖励5888元体验金已发送到您的账户中。请在“我的-我的体验金”中查看！"),
    REGISTER_INVESTOR_ACCOUNT_SUCCESS("实名认证成功", "恭喜您认证成功", "尊敬的{0}女士/先生，您申请的出借人身份已经认证成功,马上开启赚钱之旅吧！"),
    REGISTER_LOANER_ACCOUNT_SUCCESS("实名认证成功", "恭喜您认证成功", "尊敬的{0}女士/先生，您申请的借款人身份已经认证成功,马上去借款吧！"),
    ...
    RECOMMEND_SUCCESS("推荐成功", "您推荐的好友{0}已成功注册", "尊敬的用户，您推荐的好友{0}已成功注册，【邀请好友投资】您还能再拿0.5%现金奖励哦！"),
    RECOMMEND_AWARD_SUCCESS("推荐获得奖励", "{0}元推荐奖励已存入您的账户，请查收！", "尊敬的用户，您推荐的好友{0}投资成功，您已获得{1}元现金奖励。"),
    INVEST_SUCCESS("投资成功", "恭喜您成功投资{0}元", "尊敬的用户，您已成功投资房产/车辆抵押借款{0}元，独乐不如众乐，马上【邀请好友投资】还能额外拿0.5%现金奖励哦！"),
    ...
    ASSIGN_EXPERIENCE_SUCCESS("获得体验金", "{0}元活动奖励体验金已到账", "亲爱的用户，您在周年庆单笔狂欢场活动期间投资{0}元，获得{1}元体验金请注意查收。"),
    DOUBLE_ELEVEN_ACTIVITY_EVEN("双十一活动投资奇数奖励", "双十一活动投资奖励通知", "亲爱的用户，您投资的{0}项目的顺序为奇数，当项目满额放款后，我们将发送给您投资金额1.1倍的体验金奖励。"),
    DOUBLE_ELEVEN_ACTIVITY_ODD("双十一活动投资偶数奖励", "双十一活动投资奖励通知", "亲爱的用户，您投资的{0}项目的顺序为偶数，获得了一次抽奖机会，您可以前往活动页面进行抽奖。"),
