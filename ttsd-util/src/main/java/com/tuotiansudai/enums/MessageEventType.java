...
public enum MessageEventType {
    REGISTER_USER_SUCCESS("注册成功", "6888元体验金已存入您的账户，请查收！", "6888元体验金已存入您的账户，请查收！哇，您终于来啦！初次见面，岂能无礼？6888元体验金及668元现金红包双手奉上，快去投资吧！"),
    ...
    MEMBERSHIP_EXPIRED("会员到期提醒", "您的V5会员已到期，请前去购买", "尊敬的用户，您的V5会员已到期，V5会员可享受服务费7折优惠，平台也将会在V5会员生日时送上神秘礼包哦。请及时续费以免耽误您获得投资奖励！"),
    ...
    MEMBERSHIP_BUY_SUCCESS("会员购买成功", "恭喜您已成功购买{0}个月V5会员！", "尊敬的用户，恭喜您已成功购买V5会员，有效期至{0}日，【马上投资】享受会员特权吧！"),
