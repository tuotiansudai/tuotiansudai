...
public enum CsvHeaderType {
    ...
    ConsoleInvests("项目编号,项目名称,期数,资金平台,投资人,业务员,姓名,手机号,生日,省,市,推荐人,业务员,姓名,手机号,渠道,来源,投资时间,投资金额,使用优惠(使用优惠信息／实际返款),阶梯加息优惠(阶梯加息利率/实际返款),投资状态", "后台用户投资记录"),
    ...
    FinanceReportHeader("项目编号, 项目名称, 计息模式, 借款人, 他项人, 收益率, 周期, 标的金额(元), 起标日期, 投资时间, 放款时间, 投资人,投资人姓名, 推荐人, 投资金额(元), 计息天数, 回款时间, 期限, 预期收益(元), 实际收益(元), 服务费(元), 实际回款(元), 推荐奖励(元), 使用优惠(使用优惠信息), 使用优惠(实际返款), 阶梯加息优惠(阶梯加息利率), 阶梯加息优惠(实际返款)", "债券财务报表"),
    ...
    ConsoleLoanList("编号,项目名称,资金平台,借款期限,借款人,代理人,借款金额(元),年化/活动(利率),阶梯加息,项目状态,发起时间", "所有的借款"),
