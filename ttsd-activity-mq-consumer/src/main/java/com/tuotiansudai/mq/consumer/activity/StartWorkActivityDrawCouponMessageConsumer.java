...
@Component
public class StartWorkActivityDrawCouponMessageConsumer implements MessageConsumer {
    private static Logger logger = LoggerFactory.getLogger(StartWorkActivityDrawCouponMessageConsumer.class);
    ...
    public MessageQueue queue() {
        return MessageQueue.StartWorkActivity_Coupon;
    }
