...
public interface InsertNotifyMapper {
    ...
    void insertNotifyCardBind(CardBindRequestDto dto);
    ...
    @Options(useGeneratedKeys = true, keyColumn = "id")
    void insertApplyNotifyCardBind(CardBindRequestDto dto);
    ...
    @Options(useGeneratedKeys = true, keyColumn = "id")
    void insertNotifyRecharge(RechargeRequestDto dto);
    ...
    @Options(useGeneratedKeys = true, keyColumn = "id")
    void insertCustNotifyWithdraw(WithdrawRequestDto dto);
    ...
    @Options(useGeneratedKeys = true, keyColumn = "id")
    void insertApplyNotifyWithdraw(WithdrawRequestDto dto);
    ...
    @Options(useGeneratedKeys = true, keyColumn = "id")
    void insertNotifyLoanRepay(LoanRepayRequestDto dto);
