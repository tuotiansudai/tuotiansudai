...
public class LoanFullRequestDto extends PayBaseRequestDto {
    ...
    public LoanFullRequestDto(String userName, String accountNo, String loanTxNo, String loanOrderNo, String loanOrderDate, String expectRepayTime) {
        super(userName, accountNo, ApiType.LOAN_FULL.name());
