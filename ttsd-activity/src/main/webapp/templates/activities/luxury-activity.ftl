...
<@global.main pageCss="${css.luxury_activity}" pageJavascript="${js.luxury_activity}" activeNav="" activeLeftNav="" title="拓天奢侈品_拓天活动_拓天速贷" keywords="拓天速贷,拓天排行榜,拓天天豆,投资拓天,霸道总裁" description="拓天速贷二期活动,投资送天豆,参与抽大奖,拓天速贷霸道总裁送您钱,车,房.">
        ...
        <div class="luxury-item clearfix">
            ...
            <div class="step-list">
                ...
                <p>
                    ...
                    <a href="#" class="see-invite">查看邀请详情 >></a>
                </p>
            </div>
        ...
        <div class="luxury-item clearfix foot-last">
            <div class="actor-info-text">
                ...
                <ul class="rule-list">
                    ...
                    <li>8.由于本活动是为答谢广大用户所提供的回馈性质的服务，因此您在本活动中兑换的商品；</li>
