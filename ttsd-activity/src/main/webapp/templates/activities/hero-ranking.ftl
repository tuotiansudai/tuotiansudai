...
<div class="anniversary-container">
    <div class="container clearfix">
        ...
        <div class="wp actor-bg clearfix">
            ...
            <div class="model-list">
                <div class="img-rank">
                    <img src="${staticServer}/activity/images/sign/actor/anniversary/list-img.png" width="100%">
                </div>
                <div class="img-two">
            ...
            <div class="model-list">
                <div class="img-bag">
                    <img src="${staticServer}/activity/images/sign/actor/anniversary/red-bag.png" width="100%">
                </div>
                <div class="img-three">
            ...
            <div class="model-list">
                <div class="text-info">
                    <img src="${staticServer}/activity/images/sign/actor/anniversary/text-info.png" width="100%" class="responsive-pc">
                    <img src="${staticServer}/activity/images/sign/actor/anniversary/text-info-phone.png" width="100%" class="responsive-phone">
                </div>
            </div>
            <div class="model-list">
                <h3>1 周年超级VIP大派送</h3>
                <p class="content-text">不知道怎么理财？专属理财顾问送给你！服务费太高？减免！还有会员大礼包，生日福利等等等等...</p>
                <p class="content-text">部分<i class="vip-icon"></i>超级特权一览：</p>
                <ul class="feature-list">
                    <li>
                        <i class="icon-type">
                            <img src="${staticServer}/activity/images/sign/actor/anniversary/bian-icon.png" width="100%">
                        </i>
                        <p>方便快捷 随时提现</p>
                    </li>
                    <li>
                        <i class="icon-type">
                            <img src="${staticServer}/activity/images/sign/actor/anniversary/li-icon.png" width="100%">
                        </i>
                        <p>生日月 收益翻倍</p>
                    </li>
                    <li>
                        <i class="icon-type">
                            <img src="${staticServer}/activity/images/sign/actor/anniversary/zhuan-icon.png" width="100%">
                        </i>
                        <p>专属顾问 安全理财</p>
                    </li>
                    <li>
                        <i class="icon-type">
                            <img src="${staticServer}/activity/images/sign/actor/anniversary/sheng-icon.png" width="100%">
                        </i>
                        <p>会员专享 服务费折扣</p>
                    </li>
                </ul>
            ...
            <div class="model-list text-c">
                <a href="javascript:void(0)" class="get-vip" id="getVip">价值25元会员限量领取</a>
            </div>
            <div class="model-list">
                <h3>2 投资英雄榜中榜</h3>
                <p class="content-text font-20">英雄榜招募中！</p>
                <p class="content-text">7月1日至31日活动期间，每天进行英雄榜招募，上榜者可获丰富奖励！根据每人每日累计投资金额</p>
                <p class="content-text">进行排名，24：00锁定当日榜单，前十名有丰厚奖励，第一名将获得价值不菲的每日神秘大奖.</p>
            </div>
            <div class="model-list">
            ...
            <div class="model-list">
                ...
                <div class="rank-content">
                    ...
                    <div class="rank-model">
                        <h3 class="title-name">
                            历史投资英雄榜<span>(<#if yesterdayTime??>${yesterdayTime?string('yyyy-MM-dd')}</#if>)</span></h3>
                        <h3 class="list-title">
            ...
            <div class="model-list">
                <h3>3 好友投资拿红包</h3>
                <p class="content-text">当您的直接推荐人进行投资时，您将收到其年化投资本金1%的现金奖励，活动期间，每日前三名还有额外红包奖励。</p>
            </div>
            <div class="model-list mt-40">
                ...
                <div class="rank-content">
                    ...
                    <div class="rank-model">
                        <h3 class="title-name">
                            历史推荐英雄榜<span>(<#if yesterdayTime??>${yesterdayTime?string('yyyy-MM-dd')}</#if>)</span></h3>
                        <h3 class="list-title">
