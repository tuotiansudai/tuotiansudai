...
public class ActivitiesController {
    ...
    @RequestMapping(path = "/{item:^recruit|integral-draw|birth-month|rank-list-app|share-reward|app-download|landing-page|invest-achievement|loan-hike|iphone7-lottery$}", method = RequestMethod.GET)
