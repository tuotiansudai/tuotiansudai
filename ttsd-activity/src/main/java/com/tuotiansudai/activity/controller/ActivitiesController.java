...
public class ActivitiesController {
    ...
    @RequestMapping(path = "/{item:^recruit|birth-month|rank-list-app|share-reward|app-download|landing-page|landing-page-app|invest-achievement|loan-hike|share-app|share-app-android|share-app-ios$}", method = RequestMethod.GET)
