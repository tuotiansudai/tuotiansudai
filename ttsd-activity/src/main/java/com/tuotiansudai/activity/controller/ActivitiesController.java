...
public class ActivitiesController {
    ...
    @RequestMapping(path = "/{item:^recruit|integral-draw|birth-month|rank-list-app|share-reward|app-download|landing-page|invest-achievement|loan-hike|double-eleven$}", method = RequestMethod.GET)
