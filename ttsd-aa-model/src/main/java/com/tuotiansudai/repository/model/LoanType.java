...
public enum LoanType {
    ...
    INVEST_INTEREST_MONTHLY_REPAY("先付收益后还出借本金，按天计息，即投即生息", InterestInitiateType.INTEREST_START_AT_INVEST, LoanPeriodUnit.MONTH),
    ...
    //Deprecated
    LOAN_INTEREST_MONTHLY_REPAY("先付收益后还出借本金，按天计息，放款后生息", InterestInitiateType.INTEREST_START_AT_LOAN, LoanPeriodUnit.MONTH);
