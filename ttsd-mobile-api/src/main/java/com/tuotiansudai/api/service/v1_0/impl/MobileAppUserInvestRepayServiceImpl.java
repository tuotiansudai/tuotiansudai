            ...
            if (!Strings.isNullOrEmpty(investModel.getContractNo())) {
                if (investModel.getContractNo().equals("OLD")) {
                    if (investModel.getTransferInvestId() != null) {
                        ...
                        userInvestRepayResponseDataDto.setContractLocation(MessageFormat.format("{0}/v1.0/contract/transfer/transferApplicationId/{1}", this.webServer, String.valueOf(transferApplicationId)));
                    } else {
