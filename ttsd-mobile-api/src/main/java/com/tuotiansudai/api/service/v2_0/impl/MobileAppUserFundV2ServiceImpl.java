...
public class MobileAppUserFundV2ServiceImpl implements MobileAppUserFundV2Service {
    ...
    public BaseResponseDto<UserFundResponseDataDto> getUserFund(String loginName) {
        ...
        long usedMoney=investService.sumUsedFund(loginName);
        ...
        dto.setData(new UserFundResponseDataDto(userFundView, balance, point, membershipLevel, membershipPoint, usableUserCouponCount, membershipExpiredDate, membershipPrivilegeExpiredDate, experienceBalance,usedMoney));
        return dto;
    }
}
