...
public class MobileAppHomeV2Controller extends MobileAppBaseController {
    ...
    @ApiOperation("首页")
    public BaseResponseDto<LoanListResponseDataDto> index(@RequestBody BaseParamDto paramDto) {
        return mobileAppLoanListV2Service.generateIndexLoan(paramDto, getLoginName());
    }
