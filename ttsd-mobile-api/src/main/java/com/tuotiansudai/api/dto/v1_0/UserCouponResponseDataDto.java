...
public class UserCouponResponseDataDto extends BaseCouponResponseDataDto {
    ...
    public UserCouponResponseDataDto(UserCouponView userCouponView) {
        ...
        this.period = userCouponView.getPeriod();
        this.amount = AmountConverter.convertCentToString(userCouponView.getCouponAmount()).replaceAll("\\.00", "");
        ...
        this.startDate = userCouponView.getCreatedTime();
