# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-07-17 08:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[(b'HOUSE', '\u623f\u4ea7\u62b5\u62bc\u501f\u6b3e'), (b'VEHICLE', '\u8f66\u8f86\u62b5\u62bc\u501f\u6b3e'), (b'FACTORING', '\u4f01\u4e1a\u7ecf\u8425\u6027\u501f\u6b3e-\u4fdd\u7406'), (b'BILL', '\u4f01\u4e1a\u7ecf\u8425\u6027\u501f\u6b3e-\u7968\u636e'), (b'SHUIYI', '\u7a0e\u6613\u7ecf\u8425\u6027\u501f\u6b3e'), (b'HUIZU', '\u6c7d\u8f66\u878d\u8d44\u79df\u8d41')], max_length=40)),
                ('debtor', models.CharField(max_length=60)),
                ('debtor_identity_card', models.CharField(max_length=30)),
