...
/***/ function(module, exports, __webpack_require__) {
	...
	var utils = {
	    showError: function showError(element, value) {
	        element.parent().find('.error').text(value).show();
	    },
	    hideError: function hideError(element, value) {
	        element.parent().find('.error').hide();
	    },
	    validLen: function validLen(element, min, max) {
	        var min = min || false,
	            max = max || false;
	        ...
	        switch (name) {
	            case 'question':
	                errorMsg = '请描述您的问题';
	                $wordstip.removeClass('error').find('em').text(len);
	    ...
	    radioChecked: function radioChecked(element) {
