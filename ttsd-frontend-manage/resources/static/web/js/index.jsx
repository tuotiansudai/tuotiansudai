...
import 'autoNumeric';
import {isUserLogin} from 'publicJs/common';
...
(function(){
    ...
    if(imgCount>0) {
        ...
        var runimg=new runImg('bannerBox','30',imgCount);
        runimg.info();
    }
    var startMarquee2=new startMarquee();
    startMarquee2.init();
})();
...
//
// require(['imageShowSlide-v1', 'layerWrapper', 'commonFun', 'coupon-alert', 'red-envelope-float',  'jquery.validate', 'autoNumeric', 'logintip','assign_coupon'],
//
