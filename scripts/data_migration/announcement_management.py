...
class AnnouncementManagementMigrate(BaseMigrate):
    ...
    INSERT_SQL = "INSERT INTO announcement_management(`title`, `content`, `created_time`, `update_time`) VALUES(%s, %s, %s,%s)"

    def generate_params(self, old_row):
        print old_row

        return old_row['title'], old_row['body'], old_row['create_time'], old_row['update_time']
