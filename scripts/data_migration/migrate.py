...
if __name__ == '__main__':
    ...
    # tables = ['user', 'account', 'announcement_management', 'audit_log', 'bank_card', 'loan', 'loan_title_relation', 'invest', 'invest_referrer_reward', 'invest_repay', 'loan_repay', 'recharge system_bill', 'user_bill', 'user_role', 'withdraw']
