...
update account set user_name=CONCAT('王拓天',CONVERT(id,char)), identity_number=LPAD(CONVERT(id,char),18,'0'), pay_user_id=CONCAT('UB201601010000000000000000',LPAD(CONVERT(id,char),6,'0')), pay_account_id=CONCAT('02000155',LPAD(CONVERT(id,char),6,'0'));
