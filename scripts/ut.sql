...
grant select,insert,update,delete,create,drop,alter,index on fudian_bank.* to tuotiansd@'%' identified by 'tuotiansd';
grant select,insert,update,delete,create,drop,alter,index on fudian_bank.* to tuotiansd@'localhost' identified by 'tuotiansd';
