...
grant select,insert,update,delete,create,drop,alter,index on test_edxcurrent.* to sdcurrent@'%' identified by 'sdcurrent';
grant select,insert,update,delete,create,drop,alter,index on test_edxcurrent.* to sdcurrent@'localhost' identified by 'sdcurrent';
