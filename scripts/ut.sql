...
grant select,insert,update,delete,create,drop,alter,index on edxpoint.* to tuotiansd@'%' identified by 'tuotiansd';
grant select,insert,update,delete,create,drop,alter,index on edxpoint.* to tuotiansd@'localhost' identified by 'tuotiansd';
