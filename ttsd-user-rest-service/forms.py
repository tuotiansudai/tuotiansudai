...
class UserUpdateForm(wtforms.Form):
    ...
    ump_user_name = wtforms.StringField('ump_user_name', [wtforms.validators.Length(max=50)])
    ump_identity_number = wtforms.StringField('ump_identity_number', [wtforms.validators.Length(max=18)])
