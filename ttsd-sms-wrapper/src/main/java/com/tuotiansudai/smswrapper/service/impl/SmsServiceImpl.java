...
import com.tuotiansudai.smswrapper.repository.mapper.CellphoneCaptchaMapper;
...
public class SmsServiceImpl implements SmsService {
    ...
    public boolean sendCellphoneCaptcha(String mobile, String captcha) {
        Map<String, String> map = ImmutableMap.<String, String>builder().put("captcha", captcha).build();
        String content = SmsTemplate.SMS_CELLPHONE_CAPTCHA_TEMPLATE.generateContent(map);
        return smsClient.sendSMS(CellphoneCaptchaMapper.class, mobile, content);
    }
}