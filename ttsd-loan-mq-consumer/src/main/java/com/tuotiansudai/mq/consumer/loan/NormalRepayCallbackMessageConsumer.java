...
@Component
public class NormalRepayCallbackMessageConsumer implements MessageConsumer {
    private static Logger logger = LoggerFactory.getLogger(NormalRepayCallbackMessageConsumer.class);
    ...
    public MessageQueue queue() {
        return MessageQueue.NormalRepayCallback;
    }
