...
public class LoanOutSuccessSuperScholarMessageConsumer implements MessageConsumer {
    ...
    public void consume(String message) {
        ...
        redisWrapperClient.hset(SUPER_SCHOLAR_SEND_CASH_LOAN, String.valueOf(loanOutInfo.getLoanId()), DateTime.now().plusDays(1).withTimeAtStartOfDay().toString("yyyy-MM-dd HH:mm:ss"));
    }
