...
public class LoanOutSuccessNotifyForLoanOutMessageConsumerTest {

    @Autowired
    @Qualifier("loanOutSuccessNotifyForLoanOutMessageConsumer")
    ...
    public void shouldConsumeIsOk() throws JsonProcessingException {
        ...
        when(payWrapperClient.processNotifyForLoanOut(anyLong())).thenReturn(new BaseDto<>(true));
