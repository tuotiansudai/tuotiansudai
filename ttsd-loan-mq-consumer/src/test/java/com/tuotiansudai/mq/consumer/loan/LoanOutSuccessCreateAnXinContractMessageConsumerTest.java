...
public class LoanOutSuccessCreateAnXinContractMessageConsumerTest {

    @Autowired
    @Qualifier("loanOutSuccessCreateAnXinContractMessageConsumer")
    ...
    public void shouldConsumeIsOk() throws JsonProcessingException {
        ...
        when(payWrapperClient.createAnXinContract(anyLong())).thenReturn(new BaseDto<>(true));
    ...
    public void shouldConsumeIsFail() throws JsonProcessingException {
        LoanOutSuccessMessage loanOutSuccessMessage = buildMockedLoanOutSuccessMessage();
        when(payWrapperClient.createAnXinContract(anyLong())).thenReturn(new BaseDto<>(false));
