...
public enum LotteryPrize{
    ...
    PORCELAIN_CUP_BY_1000("青花瓷杯子",PrizeType.CONCRETE,ActivityCategory.POINT_DRAW_1000,3),
    PHONE_BRACKET("懒人手机支架",PrizeType.CONCRETE,ActivityCategory.POINT_DRAW_1000,13),
    PHONE_CHARGE_10("10元话费",PrizeType.CONCRETE,ActivityCategory.POINT_DRAW_1000,3),
    RED_ENVELOPE_10("10元投资红包",PrizeType.VIRTUAL,ActivityCategory.POINT_DRAW_1000,35),
    ...
    DELAYED_ACTION("通用自拍杆",PrizeType.CONCRETE,ActivityCategory.POINT_DRAW_10000,5),
    U_DISH("拓天速贷U盘",PrizeType.CONCRETE,ActivityCategory.POINT_DRAW_10000,5),
