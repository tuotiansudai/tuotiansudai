...
//
//        List<MessageCreateDto> manualMessageDtoList = messageService.findMessagePagination("title", null, null, MessageType.MANUAL, 1, 10);
//
//        List<MessageCreateDto> autoMessageDtoList = messageService.findMessagePagination("title", null, null, MessageType.EVENT, 1, 10);
//
...
//
//        messageService.createOrUpdateManualMessage("testUser", originMessageCreateDto, 0);
//        MessageCreateDto messageCreateDto = messageService.findMessageCompleteDtoByMessageId(originMessageCreateDto.getId());
...
//        messageService.createOrUpdateManualMessage("testUser", originMessageCreateDto, 0);
//        messageCreateDto = messageService.findMessageCompleteDtoByMessageId(originMessageCreateDto.getId());
//        assertEquals(originMessageCreateDto.getId(), messageCreateDto.getId());
//        assertEquals(originMessageCreateDto.getTitle(), messageCreateDto.getTitle());
//        assertEquals(originMessageCreateDto.getTemplate(), messageCreateDto.getTemplate());
//        assertEquals(originMessageCreateDto.getType(), messageCreateDto.getType());
...
//
//        assertTrue(messageMapper.findById(messageCreateDto.getId()) != null);
//    }
//
//    @Test
