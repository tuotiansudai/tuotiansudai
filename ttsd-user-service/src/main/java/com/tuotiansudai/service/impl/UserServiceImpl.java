...
public class UserServiceImpl implements UserService {
    ...
    public boolean changePassword(String loginName, String originalPassword, String newPassword, String ip, String platform, String deviceId) {
        ...
        try {
            ...
            if (returnValue) {
                mqWrapperClient.sendMessage(MessageQueue.UserSms, new SmsDto(JianZhouSmsTemplate.SMS_PASSWORD_CHANGED_NOTIFY_TEMPLATE, Lists.newArrayList(userInfoResp.getUserInfo().getMobile())));
            }
