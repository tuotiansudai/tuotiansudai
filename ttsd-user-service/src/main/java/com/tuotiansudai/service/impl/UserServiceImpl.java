...
public class UserServiceImpl implements UserService {
    ...
    public void updateUserExperienceBalanceByLoginName(long experienceAmount, String loginName, ExperienceBillOperationType experienceBillOperationType, ExperienceBillBusinessType experienceBusinessType) {
        ...
        if (experienceBillOperationType == ExperienceBillOperationType.IN) {
            experienceBalance = experienceBillOperationType == ExperienceBillOperationType.IN ? userModel.getExperienceBalance() + experienceAmount : userModel.getExperienceBalance() - experienceAmount;
        }
