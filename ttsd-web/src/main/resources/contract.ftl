...
<p>3.2 乙方进行出借资金操作之前，有义务仔细阅读本协议，充分了解并清楚知晓相应权利义务，在确认
    同意本协议各条款后,乙方点击“确认投资”选项即视为同意签署本协议,以及视为乙方已向丙方发出不可撤销的授权指令，同意授权丙方委托其指定的第三方支付机构冻结乙方确定出借的资金；冻结将在本协议生效或本协议失效时解除。</p>
...
<p>7.1 根据乙方与甲方的借款相关协议文件，甲方有义务对乙方定期还本付息。为便利、统一地回收本息
    ，乙方委托并授权丙方授权第三方支付机构代为划转甲方每期偿还本息，在每期收款日三日内与乙方进
    行结算。</p>
...
<p>当借款人短期或长期丧失还款能力（包括但不限于借款人收入情况、财产状况发生变化、人身出现
    意外、发生疾病、死亡等情况），或者借款人的还款意愿发生变化时，乙方受让的资金可能无法
    按时回收。</p>
