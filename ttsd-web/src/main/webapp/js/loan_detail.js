require(['jquery', 'pagination', 'mustache', 'text!/tpl/loan-invest-list.mustache', 'layerWrapper', 'underscore', 'jquery.ajax.extension', 'autoNumeric', 'coupon-alert'], function ($, pagination, Mustache, investListTemplate, layer, _) {
