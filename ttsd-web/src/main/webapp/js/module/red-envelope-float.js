define(['jquery', 'layerWrapper','jquery.validate', 'jquery.validate.extension','drag'], function ($,layer) {
    (function() {
        ...
        $(window).scrollTop()>($(window).height()/2)?$('.back-top',$redEnvelopFrame).fadeIn('fast'):$('.back-top').fadeOut('fast');
        ...
        $('.back-top .nav-text',$redEnvelopFrame).on('click', function(event) {//back top
