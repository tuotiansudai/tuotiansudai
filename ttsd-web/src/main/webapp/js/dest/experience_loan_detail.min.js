require(["jquery", "jquery.ajax.extension", "coupon-alert", "red-envelope-float", "jquery.form"], function (a) {
    ...
    b <= 50 ? (a(".chart-box .rount").css("transform", "rotate(" + 3.6 * b + "deg)"), a(".chart-box .rount2").hide()) : (a(".chart-box .rount").css("transform", "rotate(180deg)"), a(".chart-box .rount2").show(), a(".chart-box .rount2").css("transform", "rotate(" + 3.6 * (b - 50) + "deg)")), a.ajax({
