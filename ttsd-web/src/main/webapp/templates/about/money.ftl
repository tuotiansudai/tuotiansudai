        ...
        <div class="problem-content-item">
            <ul class="list-group active">
                <li class="problem-single-item">
                    ...
                    <p class="single-answer">答：单笔充值金额必须大于或等于1元，网银支付限额由银行或您个人设置，快捷支付时，单笔/单日限额均为5万元（招商银行除外，单笔/单日限额分别为1000元/10000元。）</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">2、充值的资金，一般多久可以到账？</p>
                    <p class="single-answer">答：网银或快捷充值都是实时到账的。</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">3、银行卡扣费成功但充值未到账的原因及处理方法？</p>
                    <p class="single-answer">答：银行卡扣费成功但充值未到账可能有银行处理超时、掉单、通讯问题等原因；您可以稍等会儿再刷新账户余额，如果确实没有到账，您可以联系客服将您的手机号、充值时间、充值金额、银行卡以及银行网银流水以截图的方式发送至在线客服，由客服审核。如为银行掉单，即这笔充值记录在联动优势没有查询到相关的充值记录，需要在充值时间的第二个工作日由联动优势和银行对账，差异账会通过3-7个工作日内退款至您的银行卡；若确定银行已扣款，需联动优势补单，拓天速贷会追加您的的账户余额，若联动优势不补单，是银行直接退款到本人的账户，视为充值失败。</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">4、绑定的银行卡以前都能充值，为什么这次充值不了？</p>
                    <p class="single-answer">答：①银行卡余额不足；<br />②电脑端更换浏览器重新操作，手机端退出APP重新操作；<br />③如仍无法解决，请联系客服热线400-169-1188。<br /></p>
                </li>
            </ul>
            <ul class="list-group">
                <li class="problem-single-item">
                ...
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">2、什么是实际收益？</p>
                    <p class="single-answer">答：“实际收益”是指按实际收益天数实际回款后，扣除相关费用，得到的实际收益，可在交易记录中查询。</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">3、自动投标怎么设置？</p>
                    <p class="single-answer">答：①电脑端：登录官方网站—我的账户—自动投标，授权后选择标的期限及投资金额（期限可多选，如：同时勾选一个月标的和三个月标的）；<br />②手机端：登录官方APP—我的财富—自动投标。</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
            ...
            <ul class="list-group">
                ...
                <li class="problem-single-item">
                    ...
                    <p class="single-answer">答：用户在平台发起账户资金提现至银行卡，页面输入支付密码和验证码确认后，资金托管方返回受理成功结果，即提现申请受理成功，工作日16:00前发起提现当日到账，其他次日（工作日）到账，具体到账因银行结算时间存在差异。</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">4、提现失败怎么办？</p>
                    <p class="single-answer">答：建议重新操作，如多次失败，请拨打客服热线400-169-1188。</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">5、提现最小金额是多少钱？</p>
                    <p class="single-answer">答：提现金额需大于2元。</p>
                </li>
                <li class="problem-single-item">
                    <i class="fa fa-angle-down"></i>
                    <p class="single-title">6、提现银行卡是否可以更换？</p>
