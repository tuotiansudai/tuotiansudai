...
<@global.main pageCss="${css.about_us}" pageJavascript="${js.about_us}" activeNav="网贷课堂" activeLeftNav="基础知识" title="基础知识_拓天速贷" keywords="拓天速贷,拓天活动,拓天排行榜,拓天理财,网贷课堂" description="拓天速贷是中国金融行业较为安全的P2P金融平台,全方位报道拓天速贷最新新闻动态,实时推出拓天速贷最新活动以及拓天公告.">
