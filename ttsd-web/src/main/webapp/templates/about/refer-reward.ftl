...
<@global.main pageCss="${css.about_us}" pageJavascript="${js.about_us}" activeNav="关于我们" activeLeftNav="推荐奖励" title="推荐奖励">
<style type="text/css">
