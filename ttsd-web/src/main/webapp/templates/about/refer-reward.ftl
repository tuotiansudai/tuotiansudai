...
<@global.main pageCss="${css.about_us}" pageJavascript="" activeNav="信息披露" activeLeftNav="推荐奖励" title="推荐奖励_拓天速贷" keywords="拓天速贷,推荐奖励,P2P理财,短期理财,短期投资,拓天速贷2级推荐机制" description="拓天速贷针对老用户推出2级推荐机制的推荐奖励,可以让您的财富快速升值.">
<style type="text/css">
