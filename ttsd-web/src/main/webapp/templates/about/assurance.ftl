    ...
    <div class="section box-wealth">
        <div class="section-title">
            ...
            <div class="page-width wealth-content">
                ...
                <p class="article-one">
                    拓天速贷由联动优势代为提供第三方资金托管及交易安全方面的工作， 拓天速贷本身不吸储、不放贷，只撮合债权债务双方，不经手资金。 “第三方托管模式”能够满足资金的去向更加明确、更加透明的诉求， 并进行有效的风险隔离。
                </p>
                <p class="article-two">
                    联动优势作为拓天速贷的资金安全保障方，为拓天速贷的用户提供安全 稳健的资金托管保障，避免用户资金的流失及其他不良事件的发生。
                </p>
                <p class="article-three">
                    联动优势是由中国移动、中国银联于2003年联合发起成立。作为专业的移动电子商务服务提供商，为普通个人用户提供安全、便捷、易用的移动电子商务服务。2011年8月31日成功入选央行公布的第二批第三方支付牌照名单。
                </p>
                <p class="article-app">
