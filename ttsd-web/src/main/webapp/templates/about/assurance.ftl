    ...
    <div class="section box-wealth">
        <div class="section-title">
            ...
            <div class="page-width wealth-content">
                ...
                <p class="article-app">
                    拓天速贷由联动优势提供第三方资金托管的工作。“第三方托管模式”能够满足资金的去向更加明确、更加透明的诉求，并进行有效的风险隔离。
                </p>
                <p class="article-app">
        ...
        <div class="page-width clearfix">
            ...
            <div class="fl">
                <p class="info-one">
                    ...
                    拓天速贷作为上市公司拓天伟业（北京）资产管理有限公司投资的互联网金融信息服务平台，能够为您提供更加优质的平台服务和更加坚实的安全保障。
                </p>
                <p>
                    <b class="sqr-title">抵押模式安全</b><br/>
                    对借款个人的信用状况、财务状况、抵押物状况、经营状况、还款来源等进行立体化、多层级的数据评估，以确保用户资金的安全。
                </p>
                <p>
                ...
                <p>
                    ...
                    拓天速贷的所有标的物信息均可在官网进行查询，债权抵押资料查询需到拓天速贷公司档案库进行调取查询，实物真伪可由拓天速贷定期组织用户前往相关机构查询，如公证处、担保平台等，以确保标的物安全透明。
                </p>
            </div>
            <div class="fr">
                <p>
                    <b class="text-18">数据安全</b><br/>
                    顶级技术团队，能够最大限度保障投资人和借款人的交易信息安全。支持安全接层协议和256位加密技术，有力地保障用户账户安全。使用高端防火墙确保网站不受侵害，保障平台数据流的安全。采用先进存储机制确保影像和合同文件数据安全。
                </p>
            </div>
