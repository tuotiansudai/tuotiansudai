<#import "../macro/global.ftl" as global>
    <@global.main pageCss="${css.about_us}" pageJavascript="${js.about_us}" activeNav="信息披露" activeLeftNav="拓天公告" title="拓天公告详情">
    <div class="about-us-container" id="noticeDetail">
        ...
        <h2 class="column-title article">
            ...
            <time class="tr">发表时间：<i>${(announce.updatedTime?string("yyyy-MM-dd"))!}</i></time>
        </h2>
