        ...
        <div class="levels">
			...
			<#-- 下面这些li标签 如果想让图标变灰色就把className最后加一个 “-hui” 例如第一个 -->
                <ul class="clearfix">
                    ...
                    <li class="vip-service${privilegeShow[4]!}">
                        <h3>贵宾专线</h3>
                        <p>贵宾级客服服务，投资问题，意见建议专享直达</p>
                    </li>
                    <li class="spec-financial-advisor${privilegeShow[5]!}">
                        <h3>专享理财顾问</h3>
                        <p>发标时间，平台活动，理财顾问第一时间通知到您</p>
                    </li>
                    <li class="birthday-benefits${privilegeShow[6]!}">
                        <h3>生日福利</h3>
	 ...
	 <#else>
         ...
         <div class="user-info-block page-width">
             <div class="info clearfix">
                 ...
                 <div class="text">
                     <p><span class="orange font20">您好！</span><span class="font14">会员有效期还有：<strong class="font22">300</strong>天</span></p>
                     <p class="font14">我的成长值：<strong class="font22"></strong></p>
                 </div>
             </div>
             <div class="progress">
                 <div class="progress-bar">
