    ...
    <form action="/transfer/purchase" method="post" id="transferForm">
        <div class="input-amount-box">
            <ul class="input-list">
                <li>
                    <label>转让价格</label>
                    <input type="text" value="${transferApplication.transferAmount}" name="amount" class="input-amount"
                           placeholder="请输入金额">
                    <em>元</em>
                </li>
            </ul>
        ...
        <input type="hidden" name="transferApplicationId" value="${transferApplication.id?string.computer}"/>
