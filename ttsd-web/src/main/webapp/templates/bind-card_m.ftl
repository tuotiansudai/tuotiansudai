...
<@global.main pageCss="${m_css.bank_card_manage}" pageJavascript="${m_js.bank_card_manage}" title="银行卡管理">
...
<div class="my-account-content bank-card-manage" id="bankCardManage">
    ...
    <div class="service bind-card">客服电话：400-169-1188（服务时间：工作日 9:00-18:00）</div>
</div>
