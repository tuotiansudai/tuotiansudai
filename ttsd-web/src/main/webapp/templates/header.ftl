<div class="header-container">
    ...
    <div class="header page-width">
        ...
        <@global.isNotAnonymous>
            <li><a class="personal-info-link"
                   href="${requestContext.getContextPath()}/personal-info"><@global.security.authentication property="principal.username"/></a>
            </li>
            ...
            <li class="header-message">
                <a href="/message/user-messages">消息<span
                        class="message-badge"><@unreadMessageCount><@global.security.authentication property="principal.username"/></@unreadMessageCount></span></a>
            </li>
        </@global.isNotAnonymous>
