        ...
        <@global.isNotAnonymous>
            ...
            <li class="header-message">
                <a href="/message/user-messages">消息
                    <span class="message-badge <@unreadMessageCount><@global.security.authentication property="principal.username"/></@unreadMessageCount>">
                        <@unreadMessageCount><@global.security.authentication property="principal.username"/></@unreadMessageCount>
                    </span>
                </a>
            </li>
        </@global.isNotAnonymous>
