    ...
    <div id="wrapperOut" class="loan-list-frame">
        <div class="loan-list-content">
            <div class="category-box-main">
                ...
                <div class="target-category-box" data-url="/m/transfer/${(transferApplicationItem.transferApplicationId)!}">
                    <b class="newer-title">${transferApplicationItem.name!}</b>
                    <ul class="loan-info clearfix">
                        <li><span class="percent-number <#if (transferApplicationItem.transferStatus == "SUCCESS")>colorChange</#if>"> <i>${transferApplicationItem.baseRate!}</i>%</span><em class="note">预期年化收益</em></li>
