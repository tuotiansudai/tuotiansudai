...
<div class="landing-phone-container">
    <div class="landing-phone-logo">
        <img src="${staticServer}/images/icons/logo.png" class="landing-phone-logo-image">
    </div>
    ...
    <div class="tuotian-advantage">
        ...
        <div class="tuotian-advantage-group clearfix">
            <span class="landing-phone-span-left"><img src="${staticServer}/images/sign/actor/landingphone/landing-phone-interest.png" class="img-icon"></span>
            <span class="landing-phone-span-right">稳健收益<br/><span>预期年化收益13%</span></span>
        </div>
        <div class="tuotian-advantage-group clearfix">
            <span class="landing-phone-span-left"><img src="${staticServer}/images/sign/actor/landingphone/landing-phone-guaranty.png" class="img-icon"></span>
            <span class="landing-phone-span-right">抵押模式<br/><span>公认的安全抵押债权</span></span>
        </div>
        <div class="tuotian-advantage-group clearfix">
            <span class="landing-phone-span-left"><img src="${staticServer}/images/sign/actor/landingphone/landing-phone-fund.png" class="img-icon"></span>
    ...
    <div class="tuotian-gifts">
        ...
        <img class="landing-phone-gift-header" src="/images/sign/actor/landingphone/landing-phone-gift-header.png"></img>
        ...
        <img class="landing-phone-gift-footer" src="/images/sign/actor/landingphone/landing-phone-gift-footer.png"></img>>
    </div>
    ...
    <div class="tuotian-aboutus">
        ...
        <div class="aboutus-content-container">
            <img class="landing-phone-aboutus-header" src="/images/sign/actor/landingphone/landing-phone-aboutus-header.png"></img>
            <div>
                <span>今日头条</span>
            </div>
            <p>
    ...
    <div class="tuotian-register">
        ...
        <div class="tuotian-register-container">
            <form>
                ...
                <input id="phonenum" name="phonenum" type="text" placeholder="手机号码"/><br>
                <div class="image-captcha-group">
                    <input id="captcha" name="captcha" type="text" placeholder="验证码"/>
                    <img id="image-captcha" src="/images/icons/hs03.png"></img>
                    <input id="btn-get-captcha" type="button" value="换一张"/>
                </div>
                <div class="phone-captcha-group">
                    <input id="phone-captcha" name="phonecaptcha" type="text" placeholder="手机验证码"/>
                    <input id="btn-get-phone-captcha" type="button" value="获取验证码"/>
                </div>
                <input id="btn-register" type="button" value="立即注册"/>
                <div class="register-protocol">
                    点击立即注册即同意拓天速贷<span>《服务协议》</span>
                </div>
            </form>
        </div>
    </div>
