                ...
                <form action="/invest" method="post">
                    ...
                    <dl class="account-list">
                        ...
                        <dd class="experience-ticket">
                            <span class="fl"><i class="fa fa-credit-card"></i> 投资体验劵1000元</span>
                            <em class="fr"><label for="use-experience-ticket"> 使用体验劵</label> <input type="checkbox" id="use-experience-ticket"></em>
                        </dd>
                        <dd class="experience-revenue" style="display: none;"><span class="fl">体验劵预期收益：</span><em class="fr"><i class="experience-interest"></i>元</em></dd>
