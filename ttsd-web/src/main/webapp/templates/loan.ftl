        ...
        <div class="loan-model borderBox no-border">
            <div class="news-share bg-w fl">
                <h2 class="hd clearfix title-block <#if loan.activityType == 'NEWBIE'>new</#if>">
                    ...
                    <div class="fl orange extra-rate" id="extra-rate">投资加息+0.4%~0.5% <i class="fa fa-question-circle-o"
                    ...
                    <div class="content">
                        <div class="row loan-number-detail">
                            <div class="col-md-4">
                                ...
                                <div class="number red">11<i class="data-extra-rate" data-extra-rate></i><span>%</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                ...
                <#if ["PREHEAT", "RAISING"]?seq_contains(loan.loanStatus)>
                    <form action="/invest" method="post" id="investForm">
                        <dl class="account-list">
                            ...
                            <dd class="clearfix"><span class="fl">账户余额：</span><a class="fr" href="#">去充值>></a><em
                                    class="fr account-amount"
                                    data-user-balance="${loan.userBalance?string.computer}">${(loan.userBalance / 100)?string("0.00")}
                                元</em></dd>
                            ...
                            <dd class="invest-amount tl" <#if loan.loanStatus == "PREHEAT">style="display: none"</#if>>
                                ...
                                <input type="text" name="amount" data-l-zero="deny" data-v-min="0.00"
                                       data-min-invest-amount="${loan.minInvestAmount}"
                                       data-max-invest-amount="${loan.maxInvestAmount}" placeholder="0.00"
                                       value="${investAmount!loan.maxAvailableInvestAmount}"
                                ...
                                <div class="col-md-6">
                                    <div class="container-fluid table">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 br-r"><i class="fa fa-check-circle-o"
                                                                          aria-hidden="true"></i>1212
                                            </div>
                                            <div class="col-xs-6 bg">1212</div>
                                            <div class="col-xs-6 br-r"><i class="fa fa-check-circle-o"
                                                                          aria-hidden="true"></i>1212
                                            ...
                                            <div class="col-xs-6 br-r br-b"><i class="fa fa-check-circle-o"
                                                                               aria-hidden="true"></i>1212
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="scroll-content">
                                    <div class="row">
                                        <a class="col" href="http://placekitten.com/200/125" rel="example_group">
                                            <img class="img" src="http://placekitten.com/200/125"
                                                 layer-src="http://placekitten.com/200/120"/>
                                        </a>
                                        <a class="col" href="http://placekitten.com/200/120" rel="example_group">
                                            <img class="img" src="http://placekitten.com/200/120"
                                                 layer-src="http://placekitten.com/200/120"/>
                                        </a>
                                        <a class="col" href="http://placekitten.com/200/120" rel="example_group">
                                            <img class="img" src="http://placekitten.com/200/120"
