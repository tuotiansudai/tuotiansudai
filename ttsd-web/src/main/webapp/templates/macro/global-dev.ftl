<#macro main pageCss pageJavascript="" staticServer="http://localhost:8088/" jsPath="js/" cssPath="style/" >
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
...
<body>
    ...
    <script type="text/javascript" charset="utf-8">
        var staticServer = 'http://localhost:8088';
    ...
    <script src="http://localhost:8088/js/config.js" type="text/javascript" charset="utf-8"></script>
    ...
    <script src="http://localhost:8088/js/cnzz_statistics.js" type="text/javascript" charset="utf-8"></script>


    <div class="hide">
        <script type="text/javascript">
            var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");
            document.write(unescape("%3Cspan id='cnzz_stat_icon_1257936541'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s4.cnzz.com/z_stat.php%3Fid%3D1257936541%26show%3Dpic1' type='text/javascript'%3E%3C/script%3E"));
        </script>
        <script type="text/javascript">
            var _hmt = _hmt || [];
            (function() {
