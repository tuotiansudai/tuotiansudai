...
<div class="content-container auto-height">
    ...
    <div class="pad-s">
        <div class="borderBox withdraw" data-access="${hasAccess}">
            ...
            <form action="/ump/withdraw" method="post"
...
<div id="popWithdraw" class="pad-m recharge-plat" style="display: none;">
    ...
    <div class="ret">
        <p>提现成功：<a href="/ump/account" class="btn-success" data-category="确认成功" data-label="withdraw">确认成功</a></p>

        <p>提现失败：<a href="/ump/withdraw" class="btn-normal" data-category="重新提现" data-label="withdraw">重新提现</a>
