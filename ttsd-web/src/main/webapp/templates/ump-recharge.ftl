...
<@global.main pageCss="${css.ump_bind_card}" pageJavascript="${js.ump_recharge}" title="充值">
<div class="ump-title">
    <a href="/ump/account">联动优势资金存管账号</a>>我要充值
</div>
<div class="content-container">
            ...
            <div class="recharge-content">
                <div class="fast-recharge <#if isFastPayOn>active</#if>">
                    ...
                    <#if isFastPayOn>
                        <div class="fast-recharge-form">
                            <form id="form2" action="/ump/recharge" method="post" <@global.role hasRole="'LOANER'">target="_blank"</@global.role>>
                ...
                <div class="e-bank-recharge <#if !isFastPayOn>active</#if>">
                    <div class="recharge-form">
                        ...
                        <form action="/ump/recharge" method="post" <@global.role hasRole="'INVESTOR', 'LOANER'">target="_blank"</@global.role>>
                            <ol>
                                <#list banks as bank>
                                    <li>
    ...
    <div id="popRecharge" class="pad-m" style="display: none;">
        ...
        <p>充值成功：<a href="/ump/account" class="btn-success" data-category="确认成功" data-label="recharge">确认成功</a></p>

        <p>充值失败：<a href="/ump/recharge" class="btn-normal" data-category="重新充值" data-label="recharge">重新充值</a>
    ...
    <div id="openFastRecharge" class="pad-m" style="display: none;">
        <a href="${requestContext.getContextPath()}/ump/recharge" class="btn-normal" data-category="继续充值" data-label="recharge">继续充值</a>
        <div class="clear-blank"></div>
