                    ...
                    <li urlLink="/loan/${(loanListWebDto.id?string('0'))!}">
                        ...
                        <div class="loan-info-frame fl">
                            ...
                            <div class="loan-info-dl">
                                ...
                                <dl>
                                    <dt>项目期限</dt>
                                    <dd><em>${loanListWebDto.periods}</em><#if loanListWebDto.type == 'INVEST_INTEREST_MONTHLY_REPAY' || loanListWebDto.type = 'LOAN_INTEREST_MONTHLY_REPAY'>个月<#else>天</#if></dd>
                                </dl>
                                <dl>
                                    <dt>招募金额</dt>
                        ...
                        <#elseif loanListWebDto.status== 'REPAYING'>
                            ...
                            <div class="rest-amount finish-invest">
                                ...
                                <#--<span class="status">回款进度:${loanListWebDto.added}期</span>-->
                                <button class="btn-normal" disabled>投资完成</button>
                            </div>
                            </div>
                        <#else>
                            <div class="loan-process">
