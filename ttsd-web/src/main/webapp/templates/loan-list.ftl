...
<#switch name!"">
    ...
    <#case '个人资金周转'>
        ...
        <#break>
    <#case '消费借款'>
        <#assign title="消费借款_投资列表_拓天速贷">
        <#assign keywords="拓天速贷,拓天产品,个人借贷,消费借款">
        <#assign description="拓天速贷优质消费借款投资产品,较高的年化收益率,高收益,高效率,低风险.">
        <#break>
    <#default>
...
<div class="loan-list-content">
    <ul class="wrapper-list" id="wrapperList">
            <li class="project-kind">
                ...
                <#assign nameMap = {"":"全部","个人资金周转":"个人资金周转","房产抵押借款":"房产抵押借款","车辆消费借款":"车辆消费借款","消费借款":"消费借款","经营性借款":"经营性借款"}>
