...
<div class="sign-container" id="weChatStartContainer">
    ...
    <div id="EntryPointForm">
        <input validate type="text" name="mobile" value="${mobile!}" placeholder="请输入手机号" maxlength="11" class="telephoneInput"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
