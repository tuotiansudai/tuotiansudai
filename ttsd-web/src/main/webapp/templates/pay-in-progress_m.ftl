...
<div class="my-account-content personal-profile loading-page">
    ...
    <form id="isPaySuccess" action="${requestContext.getContextPath()}/m/callback/${bankCallbackType.name()}/order-no/${orderNo}/is-success" method="post" style="display: none">
