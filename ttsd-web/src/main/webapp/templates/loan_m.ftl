...
<div class="my-account-content experience-amount" id="loanDetail">
    ...
    <#if extraLoanRates?? >
        <div class="invest-refer-box" style="display: none">
            ...
            <ul>
                ...
                <li><span>投资金额>${extraLoanRate.amountLower?string}元</span><span>${extraLoanRate.rate}%</span></li>
                </#list>
            </ul>
        </div>
    </#if>
    ...
    <ul class="detail-list">
        ...
        <li>
            <label>借款协议</label>
            <span><a href="${commonStaticServer}/images/pdf/loanAgreement-sample.pdf">借款转让协议（样本）<i class="fa fa-angle-right"></i></a></span>
        </li>
        <li>
            <label>项目详情</label>
