...
<div class="transfer-detail-content" id="transferDetailCon" data-user-role="<@global.role hasRole="'INVESTOR'">INVESTOR</@global.role>">
    ...
    <div class="detail-record">
        ...
        <div class="detail-record-info">
            ...
            <p>债权转让服务是指平台用户将自己所持有的债权转让给平台其他用户，由受让该债权的用户享有该债权在剩余存续期间的收益。债权转让为一对一转让。债权转让折价转让最高为本金的0.5%。</p>
            <div class="record-title"><span>常见问题</span></div>

            <div class="question-list">
                <dl>
                    <dt>1. 转让项目的优势？<i class="fa fa-chevron-circle-down fr"></i> </dt>
                    <dd>转让债权和原始债权的预期年化收益、还款方式（按月付息，到期还本）是一样的。与普通债权相比，购买转让债权时间短，可以更快的收回投资。
                ...
                <dl>
                    ...
                    <dd>债权转让折价转让最高为本金的0.5%。例如，500元债权，可最低按照497.5的价格出售，购买者花费497.5元购买到一份500元的债权。对于出让人而言，在条件同等的情况下，可比别的出让人更为快速地转让成功。</dd>
                </dl>
                <dl>
                    <dt>7. 一般多久可以转让成功？
                        <i class="fa fa-chevron-circle-down fr"></i>
