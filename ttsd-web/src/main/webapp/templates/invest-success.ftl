...
<div class="invest-success-container">
	<div class="invest-text-model">
		...
		<p class="pay-tip">支付成功，您已成功投资 50.00 元</p>
		<p class="pay-text"><span class="count-time">3</span>秒后将自动返回“我的账户”。如果页面没有跳转，您可以 <a href="/account">点击这里</a>您还可以<a href="/loan-list">继续投资</a></p>
...
<div class="invest-success-phone">
	<i class="success-tip"></i>
	<p class="pay-tip">支付成功，您已成功投资 50.00 元</p>
	<p class="pay-text"><span class="count-time">3</span>秒后将自动返回“我的账户”。</br>如果页面没有跳转，您可以 <a href="/account">点击这里</a></br>您还可以<a href="/loan-list">继续投资</a></p>
