            ...
            <tbody>
                <#if (latestInvestList?size>0)>
                    ...
                    <tr>
                        ...
                        ${(((latestInvest.corpus+latestInvest.defaultInterest+latestInvest.overdueInterest+latestInvest.expectedInterest-latestInvest.expectedFee-latestInvest.overdueFee-latestInvest.defaultFee)/100)?string('0.00'))!}<#else>-/-</#if>
                        </td>
                        <td>
