...
public class ActivitiesController {
    ...
    @RequestMapping(path = "/{item:^recruit|birth-month|rank-list-app|share-reward|app-download|landing-page|invest-achievement|anniversary-celebration$}", method = RequestMethod.GET)
