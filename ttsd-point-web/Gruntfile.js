module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        meta: {
            basePath: '../',
            baseSassPath: 'src/main/webapp/point/style/sass',
            baseCssPath: 'src/main/webapp/point/style',
            baseCssMinPath: 'src/main/webapp/point/style/dest',
            baseJsPath: 'src/main/webapp/point/js',
            baseJsMinPath: 'src/main/webapp/point/js/dest'
        },
        clean: {
            css: {
                files: [{
        ...
        dataUri: {
            dist: {
                ...
                options: {
                    target: ['./src/main/webapp/point/images/**/*.*'],
                    fixDirLevel: false,
                    maxBytes: 1024 * 8,
                    baseDir: './src/main/webapp/point'
                }
            }
        }
    });
