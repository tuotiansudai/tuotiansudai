				...
				<div class="order-table">
					<div class="order-picture">
						<p class="mater-img picture-item">
							<img src="http://localhost:9080/${productShowItem.imageUrl}" width="140" height="114"/>
						</p>
					</div>
					...
					<div class="order-price">
                        ...
                        <p><i>${productShowItem.points?string('0')}</i>积分</p>
					</div>
					...
					<div class="order-count">
                        ...
                        <p><i class="count-num"
                              data-num="${productShowItem.points?string('0')}">${productShowItem.points * number}</i>积分
                        </p>
					</div>
				</div>
			</div>
