        ...
        <div class="store-login">
            ...
            <ul class="other-list">
                ...
                <li>
                    ...
                    <p><a href="${webServer}/loan-list">去出借</a></p>
                </li>
            </ul>
            <#if isLogin>
...
<div class="rule-info-tip" id="ruleInfoTip">
    ...
    <p>3.出借赚积分：</p>
    <p class="mb-15">出借拓天速贷直投项目，出借年化积分=出借金额*出借天数/365。</p>
    <p><span>积分的用途</span></p>
    <p class="mb-15">用户可以用账户相应的积分进行商品兑换实物商品或优惠券或者抽奖。</p>
    <p><span>拓天速贷积分规则</span></p>
    <p>1.用户出借30天、90天、180天、360天抵押类债权，根据累计年化出借额，可获得等值的兑换积分。出借体验项目及债权转让不参与积分的累计，积分只 保留整数位，小数点后部分直接抹去；</p>
