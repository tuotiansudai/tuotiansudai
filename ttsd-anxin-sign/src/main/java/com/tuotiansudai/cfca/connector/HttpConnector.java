...
//            request.append(channel).append("=").append(URLEncoder.encode(channel, SystemConst.DEFAULT_CHARSET));
//            if (CommonUtil.isNotEmpty(data)) {
//                request.append("&").append(DATA).append("=").append(URLEncoder.encode(data, SystemConst.DEFAULT_CHARSET));
//            }
//            if (CommonUtil.isNotEmpty(signature)) {
//                request.append("&").append(SIGNATURE).append("=").append(URLEncoder.encode(signature, SystemConst.DEFAULT_CHARSET));
//            }
