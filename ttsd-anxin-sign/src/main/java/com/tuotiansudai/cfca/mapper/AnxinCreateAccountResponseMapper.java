...
public interface AnxinCreateAccountResponseMapper {
    ...
    @Insert("insert into anxin_create_account_response (tx_time, ret_code, ret_message, user_id, person_name, ident_type_code, ident_no, email, mobile_phone, address, authentication_mode, not_send_pwd, anxin_sign_email, anxin_sign_mobile_phone, created_time) " +
