...
public class ActivitiesController {
    ...
    @RequestMapping(path = "/{item:^recruit|activity-money-tree|material-point|integral-draw|birth-month|rank-list-app|share-reward|app-download|landing-page|invest-achievement|landing-anxin|loan-hike|heavily-courtship$}", method = RequestMethod.GET)
