...
public class ActivitiesController {
    ...
    @RequestMapping(path = "/{item:^money_tree|landing-page|invest-achievement|landing-anxin|point-update|sign-check|wx-register|divide-money|minsheng|guarantee|midsummer|lottery-intro|icp-intro|double-landing$}", method = RequestMethod.GET)
