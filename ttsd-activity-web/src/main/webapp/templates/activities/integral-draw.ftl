...
<div class="integral-draw-frame" id="integralDrawPage">
    ...
    <div class="activity-note-tip">
        ...
        <p>
            ...
            4.拓天速贷将于每年10月21日24:00，对用户积分进行清零，清零后积分将重新累计，请您提前进行兑换；<br/>
    ...
    <#--积分不足-->
        <div class="tip-list" data-return="nopoint">
            <div class="close-btn go-close"></div>
            <div class="text-tip">
                <p class="login-text">您的积分不足~</p>
                <p class="des-text">投资赚取更多积分再来抽奖吧！</p>
            </div>
            <div class="btn-list"><a href="javascript:void(0)" class="go-close">知道了</a></div>
        </div>
