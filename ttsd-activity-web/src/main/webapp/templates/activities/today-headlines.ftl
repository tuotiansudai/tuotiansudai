...
<@global.main pageCss="${css.today_headlines}" pageJavascript="${js.today_headlines}" activeNav="" activeLeftNav="" title="拓天双11活动_活动中心_拓天速贷" keywords="撩妹神器,撩妹礼包,投资活动,拓天速贷" description="拓天速贷双11活动,推出撩妹神器'息'结良缘限时专享标,收益增加1.1%,并送'撩妹礼包',你撩妹,我买单,单身狗抽奖还可获100%中奖机会.">
<div class="today-headlines-container">
        ...
        <div class="intro-text-group">
            <div class="bg-item">
                <div class="intro-item">
                    <p>加班狗：说好早点回家，却带着早点回了家</p>
                    <p>应酬仔：为了0.1%的业绩，喝到吐也得继续虐</p>
                    <p>创业哥：世上败家的方法那么多，哥选的偏是NO.1</p>
                    <p>住房、养老、教育、环境、堵车……生活鸭梨山大？</p>
                    <p>点击鸭梨，开始解救！</p>
                </div>
            </div>
        </div>
            ...
            <form class="register-form" id="registerForm" action="/register/user" method="post" autocomplete="off" novalidate="novalidate">
                <ul class="register-list">
                    <li>
                        ...
                        <input type="text" id="mobile" name="mobile" class="int-item" placeholder="手机号" maxlength="11">
                    </li>
                    <li>
                        <i class="icon-pass"></i>
                        <input type="password" id="password" name="password" placeholder="密码" maxlength="20" class="int-item">
                    </li>
                    <li>
                        <i class="icon-code"></i>
                        <input type="text" id="appCaptcha" name="appCaptcha" placeholder="验证码" maxlength="5" class="int-item appCaptcha">
                        <em class="image-captcha">
                            <img class="captcha-register" src="" width="100" height="41">
                        </em>
                    </li>
                    <li>
                        <i class="icon-captcha"></i>
                        <span class="captcha-tag" id="pcCaptcha">
                            <input type="text" class="int-item captcha" autocomplete="off" name="captcha" id="captcha" autocorrect="off" autocapitalize="off" placeholder="手机验证码" maxlength="6">
                            <button type="button" class="fetch-captcha btn" disabled="disabled">获取验证码</button>
                        </span>
                    </li>
                    <li class="mobile-agreement">
                    ...
                    <li>
                        <label class="login-link">已注册 <span class="login-btn">登录</span></label>
                    </li>
                </ul>
            </form>
        </div>
        ...
        <div class="tip-bg">
            ...
            <form class="login-form" id="loginForm" action="/login" method="post" autocomplete="off" novalidate="novalidate">
                ...
                <ul class="register-list">
                    <li>
                        <i class="icon-phone"></i>
                        <input type="text" id="username" name="username" class="int-item" placeholder="请输入账号/手机号" maxlength="11">
                    </li>
                    <li>
                        <i class="icon-pass"></i>
                        <input type="password" id="password" name="password" placeholder="请输入密码" maxlength="20" class="int-item">
                    </li>
                    <li>
                        <i class="icon-code"></i>
                        <input type="text" id="captcha" name="captcha" placeholder="请输入验证码" maxlength="5" class="int-item appCaptcha">
                        <em class="image-captcha">
                            <img class="captcha-login" src="/login/captcha" width="100" height="41">
                        </em>
                    </li>
                    ...
                    <li>
                        <label class="login-link">没有账号 <span class="go-register">去注册>></span></label>
                    </li>
                </ul>
            </form>
        </div>
            ...
            <form class="attest-form" id="attestForm" action="/register/account" method="post" autocomplete="off" novalidate="novalidate">
                <ul class="register-list mt-b">
                    ...
                    <li>
                        ...
                        <input type="text" id="identityNumber" name="identityNumber" placeholder="请输入您的身份证号码" class="int-item">
                    </li>
                    <li class="text-c">
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                        <span class="submit-bg">
                            <input type="submit" class="register-user" value="立即认证">
                        </span>
                    </li>
                </ul>
            </form>
    ...
    <div class="tip-box" id="noChanceBox">
        <div class="tip-bg">
            <div class="gift-title no-chance">
                <p>哎呀！没有抽奖机会了，</p>
                <p>下载APP还有更多福利拿哦~</p>
            </div>
            <ul class="register-list mt-b">
