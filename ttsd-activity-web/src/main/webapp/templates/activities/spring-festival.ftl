...
<@global.main pageCss="${css.spring_festival}" pageJavascript="${js.spring_festival}" activeNav="" activeLeftNav="" title="生日月特权_拓天活动_拓天速贷" keywords="拓天速贷,拓天活动.生日活动,生日月特权" description="拓天速贷专属生日月特权,生日月投资收益翻倍,拓天速贷专属活动超高收益等你拿.">
