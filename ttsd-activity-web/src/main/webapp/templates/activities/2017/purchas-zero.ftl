                        ...
                        <li>
                            ...
                            <a href="/activity/zero-shopping/article?zeroShoppingPrize=Apple_MacBook">
                                ...
                                <div class="fr">
                                    ...
                                    <a href="/activity/zero-shopping/article?zeroShoppingPrize=Apple_MacBook<#if isAppSource>&appVersion=${appVersion!}</#if>" class="invest-btn margin-less">投资90000元可得</a>
                                </div>
                            </a>
                        </li>
                        <li>
