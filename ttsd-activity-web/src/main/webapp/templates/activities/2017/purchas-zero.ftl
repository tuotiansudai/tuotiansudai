...
<@global.main pageCss="${css.purchas_zero_2017}" pageJavascript="${js.purchas_zero_2017}" activeNav="" activeLeftNav="" title="好货0元购_活动中心_拓天速贷" keywords="拓天速贷,0元购,商品奖励,专享项目" description="拓天速贷好货0元购活动,活动期间用户点选心仪好货,通过活动页面'立即投资'按钮进入投资页面,投资带有'0元购'标签的专享项目达到该商品对应投资额,即可0元白拿商品.">
...
<div id="purchas_zero" class="shopping-zero-frame">
                        ...
                        <li>
                            ...
                            <a href="/activity/zero-shopping/article?zeroShoppingPrize=Trolley_case<#if isAppSource>&source=app&token=${token!}&appVersion=${appVersion!}</#if>">
                                ...
                                <div class="fr">
                                    ...
                                    <a href="/activity/zero-shopping/article?zeroShoppingPrize=Trolley_case<#if isAppSource>&source=app&token=${token!}&appVersion=${appVersion!}" class="invest-btn">投资4800元可得</a>
                                </div>
                            </a>
                        </li>
                        <li>
    ...
    <div class="kindly-tips page-width">
        ...
        <div class="tips-content">
            <dl>
                <dd>1、用户在点选心仪商品后，需通过活动页面的“立即投资”按钮进行投资，方可成功兑换奖励；</dd>
                <dd>2、用户在每次点选心仪商品后，需按该商品指定的投资额进行投资，如超出指定商品所需投资额，则超出部分的投资额不予兑换更多奖励。如欲兑换多项商品，每次兑换时均需在活动页面点选该商品，并通过活动页面中“立即投资”按钮进行投资；</dd>
