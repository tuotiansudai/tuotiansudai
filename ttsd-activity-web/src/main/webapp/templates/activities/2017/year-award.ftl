...
<#--奖品提示-->
    ...
    <div class="show_middle_box">
        ...
        <div class="title_ammount">
            <div class="current_ammount">当前年化投资额：15,943,291.23元</div>
            <div class="my_ammount">我的奖励：1000.00元</div>
        </div>
    ...
    <div class="show_middle_box">
        ...
        <div class="rank_list_survey" id="rank_list_survey">
            <span class="date_info">日期：<span class="date_info_No">2017-8-29</span></span>
            <span class="myRank_info">我的排名：<span class="myRank_info_No">1</span></span>
            <#--<span class="myRank_info">我的排名：<a href="/login" target="_blank" class="myRank_info_No">登录</a></span>-->
            <span class="today_totalAccount"><span class="is-today">当日</span>累计投资：<span class="today_totalAccountNo">10000元</span></span>
