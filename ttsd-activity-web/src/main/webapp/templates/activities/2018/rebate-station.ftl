...
<div class="activity-wrap-main">
    ...
    <div class="tips_container">
        ...
        <p>1. 活动期间，老用户每笔投资成功后，均可在活动页面生成一个该笔投资专属的助力链接，老用户需分享此链接方可该笔投资助力加息；</p>
        <p>2. 每笔投资助力人数累计时间截止至该笔投资后24小时，超过24小时后的好友助力，不再计入该笔投资助力人数；</p>
        <p>3. 每人每日最多可帮助5名好友助力；</p>
        <p>4. 老用户及其好友的投资加息返现奖励将于项目放款后24小时后发放至拓天速贷账户；截止发放时间为止，如果助力好友未登录拓天速贷并进行实名认证，将无法收到现金；</p>
        <p>5.“人人可领10元现金”活动，每个注册用户于活动期间仅限参与一次，用户第一次分享后24小时内参与助力的有效。</p>
        <p>6:“人人可领10元现金”奖励将于用户分享倒计时结束后24小时统一发放至用户拓天速贷账户；截止发放时间为止，如果未登录拓天速贷并完成实名认证，将无法收到奖励；</p>
        <p>7. 活动中所获加息券即时发放，用户可在PC端“我的账户”或App端“我的-优惠券”中进行查看；</p>
