...
<div class="july-container">
   <div class="part team-logo-wrap activity-page">
       ...
       <div class="main-content borderYellow">
           ...
           <div id="openBallContent" class="content-section open-balls-content content-page marginTop40" data-drawcount="${drawCount?c}">
       ...
       <div class="main-content borderYellow">
           <div class="content-section content-page">
               ...
               <div class="inveite-friend-desc">
                   <p>1、活动期间，用户投资后，<strong>微信扫描</strong>下方二维码，进入拓天速贷服务号，回复口令<strong>“拆红包”</strong>，可分享专属现金红包给好友，邀请好友领取；</p>
                   <p> 2、根据累计领取好友人数，该投资用户可享受其活动期间累计投资额（年化）的<strong>0.1%-0.5%返现</strong>奖励；</p>

                   <div class="open-red-ware-tab">
                       <table>
                           <tr><td class="ren">拆红包人数</td><td>1</td><td>2</td><td>3</td></tr>
                           <tr><td>投资返现比率（年化）</td><td>0.1%</td><td>0.2%</td><td>0.5%</td></tr>
                       </table>
                   </div>
        ...
        <div class="main-content borderYellow">
            <div class="content-section content-page ">
                ...
                <div class="calculation-formula">
                    <table>
                        <tr>
                            <td>60天-90天项目</td> <td>年化投资额=实际投资额*90/360</td>
                        </tr>
                        <tr>
                            <td>120天-180天项目</td> <td>年化投资额=实际投资额*180/360</td>
                        </tr>
                        <tr>
                            <td>330天-360天项目</td> <td>年化投资额=实际投资额</td>
                        </tr>
                    </table>
                </div>
