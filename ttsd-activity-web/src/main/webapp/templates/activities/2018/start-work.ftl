    ...
    <div class="activity-page">
        ...
        <div class="gold-person-container">
            ...
            <div class="main">
                ...
                <div class="title_wrapper" style="display: block"><span style="margin-left: 10px">我的小金人<span style="color: #c4050d;font-size: 20px" id="gold_count">10</span>个</span><span class="record_text">我的兑换记录</span>
