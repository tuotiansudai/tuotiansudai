...
<@global.main pageCss="${css.red_envelop_split}" pageJavascript="${js.red_envelop_split}" activeNav="" activeLeftNav="" title="送您5888元体验金" keywords="拓天速贷,新手投资,新手加息券,新手红包" description="一次体验，受益终生，拓天速贷一周年，这是用心的回馈">
    <div class="red-envelop-container">
        ...
        <div class="register-section-box">
            ...
            <div class="flow-box invite-friend">
                <span class="reward-msg">
                    <em>送好友8.88元红包，好友注册，您即可领取
最高20.88元的现金红包哦！</em>
                </span>
                <button type="button" class="normal-button">立即邀请赚红包</button>
            </div>
        </div>
        ...
        <div class="red-envelop-detail">
            ...
            <div class="envelop-box">
                <div class="activity-rule">
                    <span>给好友发送邀请链接</span>
                    <span>好友完成注册领取8.88元红包</span>
                    <span>邀请成功赚取红包</span>
                </div>

                <ul>
                    <li>
                        活动期间（01-05至01-10），通过本页面邀请好友注册即可参与活动；
                        本次活动与邀请好友机制奖励共享，好友投资您依然可以获得1%的推荐奖励；
                        好友通过您的分享链接注册即可获得8.88元红包以及新手5888元体验金和588元优惠券；
                        根据您邀请好友注册的人数不同，您可以获得的红包金额如下：
                    </li>
                </ul>
            </div>
        </div>
