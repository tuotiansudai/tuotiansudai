...
<div class="landing-container-app landing-container-game" id="landingAppTag">
    <div class="register-box">
        <form class="register-user-form" action="/register/user" method="post" autocomplete="off"
            ...
            <ul class="reg-list tl register-step-one">
                <li class="bg-col">
                    <input type="hidden" name="redirectToAfterRegisterSuccess" value="/activity/landing-game">
                ...
                <li class="code bg-col col-captcha">
                    <input type="text" id="appCaptcha" name="appCaptcha" placeholder="请输入右侧图形验证码" maxlength="5"
                ...
                <li id="agreementInputErr" style="display: none"></li>
                <li class="tr mobile-agreement">
                    <label>领取即同意<a href="javascript:void(0);" class="show-agreement">《服务协议》</a></label>
                </li>
            </ul>
        </form>
    </div>
    ...
    <div class="my-advantage">
        ...
        <div class="info-text">
            ...
            2. 成功投资新手体验项目后，可获得588投资红包及3%加息券；<br/>
            3. 奖励可在“我的账户-我的宝藏”查看；<br/>
            4. 新手体验项目所得红包奖励需投资后方可提现，不可与其他红包及加息券共用；<br/>
            5. 每个身份证仅限参加一次，刷奖、冒用他人身份证、银行卡者一经核实，取消活动资格，所得奖励不予承兑；<br/>
...
<div id="agreementBox" style="display: none;">
    <div class="pad-m">
        ...
        <p>
            6.3因您选择使用本网站提供的服务、参与的交易等而产生的直接或间接损失均由您自身承担，该等损失包括但不限于资金损失、利润损失、营业中断等。本网站及本网站的管理公司的股东、创始人、全体员工、权证人、关联公司、子公司、分公司均不对以上损失承担任何责任。</p>
