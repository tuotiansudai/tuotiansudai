...
<@global.main pageCss="${css.money_tree}" pageJavascript="${js.money_tree}" activeNav="" activeLeftNav="" title="生日月特权_拓天活动_拓天速贷" keywords="拓天速贷,拓天活动.生日活动,生日月特权" description="拓天速贷专属生日月特权,生日月投资收益翻倍,拓天速贷专属活动超高收益等你拿.">
...
<div class="invite-des-container">
    <div class="invite-des-box-bg">
        <div class="invite-des-box">
            ...
            <p>每日用户最多可额外获得<b>3</b>次摇奖机会，超出部分的邀请不予累计。</p>
        </div>
    </div>
</div>
...
<div class="money-tree-container">
    ...
    <div class="tip-des-box">
        ...
        <p>3. 用户每日最多可额外获得3次摇奖机会，超出部分的邀请不予累计。</p>
        <p>4. 活动截止时间：2017年5月20日</p>
    </div>
</div>
