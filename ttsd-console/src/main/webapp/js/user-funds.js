...
require(['jquery', 'bootstrap','bootstrapSelect','bootstrapDatetimepicker','jquery-ui'], function ($) {
    $(function () {
        ...
        $('.down-load').click(function(){
            ...
            var operationType = $('.operationType').val();
            var businessType = $('.businessType').val();
            window.location.href = "/userFunds?loginName="+loginName+"&startTime="+startTime+"&endTime="+endTime+"&userBillOperationType="+operationType+"&userBillBusinessType="+businessType+"&downLoad=csv";
        });
    });
})