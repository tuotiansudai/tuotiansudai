        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>${invest.transferStatus.description}
                        <#if invest.transferStatus == 'TRANSFERABLE' ||  invest.transferStatus == 'NONTRANSFERABLE'>
                            <button type="button" class="btn btn-sm btn-primary updateTransferStatus"
                                    data-investid="${invest.investId?string.computer}"
                                    data-investtransferstatus="${invest.transferStatus}">修改</button>
                        </#if>
                    </td>
