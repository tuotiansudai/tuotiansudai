...
<div class="form-group"><label class="col-sm-2 control-label">抵押物所在地: </label>
    <div class="col-sm-4"><input name="pledgeLocation" value="${loan.pledgeHouse.pledgeLocation}" type="text" class="form-control"
                                 datatype="*"
...
<div class="form-group"><label class="col-sm-2 control-label">借款抵押房产面积: </label>
    <div class="col-sm-4"><input name="square" value="${loan.pledgeHouse.square}" type="text" class="form-control"
                                 datatype="*"
                                 errormsg="借款抵押房产面积不能为空"></div>
</div>
<div class="form-group"><label class="col-sm-2 control-label">公证书: </label>
    <div class="col-sm-4"><input name="authenticAct" value="${loan.pledgeHouse.authenticAct}" type="text" class="form-control"
...
<div class="form-group"><label class="col-sm-2 control-label">抵押物借款金额: </label>
    <div class="col-sm-4"><input name="pledgeLoanAmount" value="${loan.pledgeHouse.pledgeLoanAmount}" type="text" class="form-control"
