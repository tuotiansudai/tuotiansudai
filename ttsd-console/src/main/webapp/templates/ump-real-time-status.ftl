...
<@global.main pageCss="" pageJavascript="ump-real-time-status.js" headLab="finance-manage" sideLab="umpRealTimeStatus" title="联动优势余额查询">
...
<div class="col-md-10">
    <form action="" method="get" class="form-inline query-build">
        ...
        <div class="login-name form-group" <#if type?? && type != 'user'>style="display: none"</#if>>
            <label for="loginName">手机号或用户ID</label>
