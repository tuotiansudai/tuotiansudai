            ...
            <div class="col-md-10">
                <form class="form-horizontal jq-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control jq-user" placeholder="" datatype="*" errormsg="借款项目名称不能为空" value="${loanInfo.name}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="tags" class="form-control ui-autocomplete-input" datatype="*" autocomplete="off"
                                   placeholder="" errormsg="借款用户不能为空" value="${loanInfo.loanerLoginName}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control jq-timer" placeholder="" datatype="num"  errormsg="借款期限需要填写数字" value="${loanInfo.periods}">
                    ...
                    <div class="form-group input-append">
                        ...
                        <div class="col-sm-4">
                            <div class='input-group date' id='datetimepicker6'>
                                <input type='text' class="form-control jq-star-date" datatype="date" errormsg="筹款启动时间需要正确填写" value="${(loanInfo.fundraisingStartTime?string('yyyy-MM-dd HH:mm'))!}"/>
                    ...
                    <div class="form-group input-append">
                        ...
                        <div class="col-sm-4">
                            <div class='input-group date' id='datetimepicker7'>
                                <input type='text' class="form-control jq-end-date" datatype="date" errormsg="筹款截止时间需要正确填写" value="${(loanInfo.fundraisingEndTime?string('yyyy-MM-dd HH:mm'))!}"/>
					                <span class="input-group-addon">
					                    <span class="glyphicon glyphicon-calendar"></span>
					                </span>
                            </div>
