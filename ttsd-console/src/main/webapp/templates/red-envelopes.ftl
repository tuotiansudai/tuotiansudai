...
<@global.main pageCss="" pageJavascript="coupons.js" headLab="activity-manage" sideLab="statisticsRedEnvelope" title="现金红包管理">
                        ...
                        <#else>
                            ...
                            <#else>
                                ...
                                <@security.authorize access="hasAnyAuthority('OPERATOR','ADMIN')">
                                    <a href="/activity-manage/coupon/${coupon.id?string('0')}/edit"
                                       class="btn-link">编辑</a> /
