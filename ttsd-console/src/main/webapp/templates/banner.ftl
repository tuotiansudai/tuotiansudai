...
<div class="col-md-10">
    ...
    <form action="" method="post" class="form-horizontal form-list banner-form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="name" placeholder="" datatype="*" errormsg="名称不能为空">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="url" placeholder="" datatype="*" errormsg="链接不能为空">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" name="title" placeholder="" datatype="*" errormsg="分享后标题不能为空">
            </div>
        </div>
