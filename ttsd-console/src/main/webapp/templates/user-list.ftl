...
<div class="col-md-10">
    <form action="" class="form-inline query-build">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control ui-autocomplete-input" id="input-referrer" name="referrer"
                   placeholder="" datatype="*" autocomplete="off" value="${referrer!}">
        </div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr <#if userItem.status!='ACTIVE'> class="bg-warning" </#if> >
                    ...
                    <td><a href="/user-manage/user/${userItem.loginName}/edit">编辑</a> |
                        <#if userItem.status=='ACTIVE'>
                            <a class="user-status-modifier" href="#"
                               data-url="/user-manage/user/${userItem.loginName}/disable">禁止</a>
                        <#else>
                            <a class="user-status-modifier" href="#"
