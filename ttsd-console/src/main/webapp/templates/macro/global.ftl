        ...
        [
            ...
            },
            {
                ...
                [
                    ...
                    {"name":"","class":"sub-title-1","text":"消费借款申请","link":"","role":"'ADMIN','RISK_CONTROL_STAFF','OPERATOR_ADMIN','OPERATOR'"},
                        {"name":"loanApplicationList","text":"借款申请列表","link":"/loan-application/consume-list","role":"'ADMIN','RISK_CONTROL_STAFF','OPERATOR_ADMIN','OPERATOR'"},
            ...
            },
            {
                ...
                "sidebar":[
                    {"name":"","class":"sub-title-1","text":"用户管理","link":"","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN'"},
                        ...
                        {"name":"riskEstimateLimit","text":"投资限额管理","link":"/user-manage/risk-estimate/limit","role":"'ADMIN','OPERATOR_ADMIN'"}
                ]
            },
            {
                "name":"finance-manage",
                ...
                "sidebar":[
                    ...
                    {"name":"","class":"sub-title-1","text":"用户账户管理","link":"","role":"'ADMIN','CUSTOMER_SERVICE','OPERATOR','OPERATOR_ADMIN','FINANCE_ADMIN'"},
            ...
            },
            {
                ...
                "sidebar":[
                    ...
                    {"name":"","class":"sub-title-1","text":"活动列表","link":"","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN','CUSTOMER_SERVICE'"},
                        ...
                        {"name":"thirdAnniversary","text":"3周年活动 ","link":"/activity-console/activity-manage/third-anniversary-list","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN'"}
                ]
            },
            {
            ...
            },
            {
                ...
                "sidebar":[
                    ...
                    {"name":"","class":"sub-title-1","text":"用户投资数据","link":"","role":"'ADMIN','CUSTOMER_SERVICE','OPERATOR','OPERATOR_ADMIN'"},
                        ...
                        {"name":"userInvestCount","text":"放款金额时间分布","link":"/statistic","role":"'ADMIN','CUSTOMER_SERVICE','OPERATOR','OPERATOR_ADMIN'"},
            ...
            },
            {
                ...
                "sidebar":[
                    {"name":"","class":"sub-title-1","text":"用户积分管理","link":"","role":"'ADMIN','CUSTOMER_SERVICE','OPERATOR','OPERATOR_ADMIN'"},
                        ...
                        {"name":"channelPoint","text":"导入渠道积分记录","link":"/point-manage/channel-point","role":"'ADMIN','DATA'"},
                        {"name":"pointBillConsume","text":"积分消耗记录","link":"/point-manage/point-consume","role":"'ADMIN','DATA'"},
