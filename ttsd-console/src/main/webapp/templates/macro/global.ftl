...
<#assign menus=
        [
            ...
            },
            {
                ...
                "header":{"text":"活动管理"},
                "sidebar":[
                    {"name":"createCoupon","text":"创建优惠券","link":"/activity-manage/coupon","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN'"},
                    {"name":"statisticsCoupon","text":"优惠券列表","link":"/activity-manage/coupons","role":"'ADMIN','OPERATOR','OPERATOR_ADMIN'"},
