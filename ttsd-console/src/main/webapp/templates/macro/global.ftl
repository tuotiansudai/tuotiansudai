        ...
        [
            ...
            },
            {
                ...
                [
                    ...
                    {"name":"","class":"sub-title-1","text":"消费借款申请","link":"","role":"'ADMIN','RISK_CONTROL_STAFF','OPERATOR_ADMIN'"},
                        {"name":"contract","text":"借款申请列表","link":"/loan-application/consume-list","role":"'ADMIN','RISK_CONTROL_STAFF','OPERATOR_ADMIN'"},
