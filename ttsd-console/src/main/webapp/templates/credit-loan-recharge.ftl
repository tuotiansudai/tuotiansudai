...
<@global.main pageCss="" pageJavascript="system-recharge.js" headLab="finance-manage" sideLab="systemRecharge" title="信用贷标的账户充值">

<!-- content area begin -->
<div class="col-md-10">
    <form class="form-horizontal" action="/finance-manage/credit-loan-recharge" method="post">
