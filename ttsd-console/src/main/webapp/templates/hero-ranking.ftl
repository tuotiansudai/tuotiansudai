    ...
    <div class="mysteriousPrize">
        <form class="prize-form" action="/activity-manage/upload-image" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="prizeName"  class="form-control prize-ame" value="" placeholder="" datatype="*" errormsg="名称不能为空">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-1 control-label">图片: </label>
                <div class="col-sm-4 ">
                    <input type="text" name="imageUrl" value="" readonly class="form-control image-url" placeholder="" datatype="*" errormsg="图片不能为空">
