...
@Service
public class ConsoleLoanCreateServiceImpl implements ConsoleLoanCreateService {

    private static Logger logger = Logger.getLogger(ConsoleLoanCreateServiceImpl.class);
