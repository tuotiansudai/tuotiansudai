...
@ActiveProfiles("test")
@ContextConfiguration(locations = {"classpath:dispatcher-servlet.xml", "classpath:spring-security.xml", "classpath:applicationContext.xml", "classpath:spring-session.xml"})@Transactional
