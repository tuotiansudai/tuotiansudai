...
public enum LotteryPrize {
    ...
    //春节活动
    SPRING_FESTIVAL_RED_ENVELOP_68("6.8元红包", PrizeType.VIRTUAL, ActivityCategory.SPRING_FESTIVAL_ACTIVITY, 6),
    SPRING_FESTIVAL_RED_ENVELOP_58("5.8元红包", PrizeType.VIRTUAL, ActivityCategory.SPRING_FESTIVAL_ACTIVITY, 12),
    SPRING_FESTIVAL_RED_ENVELOP_38("3.8元红包", PrizeType.VIRTUAL, ActivityCategory.SPRING_FESTIVAL_ACTIVITY, 16),
    SPRING_FESTIVAL_RED_ENVELOP_18("1.8元红包", PrizeType.VIRTUAL, ActivityCategory.SPRING_FESTIVAL_ACTIVITY, 20),
    SPRING_FESTIVAL_RED_ENVELOP_88("8.8元红包", PrizeType.VIRTUAL, ActivityCategory.SPRING_FESTIVAL_ACTIVITY, 15),
    SPRING_FESTIVAL_RED_ENVELOP_188("18.8元红包", PrizeType.VIRTUAL, ActivityCategory.SPRING_FESTIVAL_ACTIVITY, 15),
