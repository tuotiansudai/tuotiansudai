...
public enum LotteryPrize {
    ...
    //元宵节
    LANTERN_FESTIVAL_RED_ENVELOPE_5("5元红包",PrizeType.VIRTUAL,ActivityCategory.LANTERN_FESTIVAL_ACTIVITY,30),
    LANTERN_FESTIVAL_RED_ENVELOPE_8("8元红包",PrizeType.VIRTUAL,ActivityCategory.LANTERN_FESTIVAL_ACTIVITY,15),
    LANTERN_FESTIVAL_RED_ENVELOPE_10("10元红包",PrizeType.VIRTUAL,ActivityCategory.LANTERN_FESTIVAL_ACTIVITY,15),
    LANTERN_FESTIVAL_RED_ENVELOPE_40("40元红包",PrizeType.VIRTUAL,ActivityCategory.LANTERN_FESTIVAL_ACTIVITY,5),
    LANTERN_FESTIVAL_RED_ENVELOPE_30("30元红包",PrizeType.VIRTUAL,ActivityCategory.LANTERN_FESTIVAL_ACTIVITY,10),
